            ...
            modelBuilder.Entity("Data.Entities.AppliedPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PostID = 1,
                            BuilderID = 1,
                            AppliedDate = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7536),
                            QuizId = 1,
                            Status = 6
                        },
                        new
                        {
                            PostID = 1,
                            BuilderID = 2,
                            AppliedDate = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7550),
                            QuizId = 1,
                            Status = 6
                        },
                        new
                        {
                            PostID = 1,
                            BuilderID = 3,
                            AppliedDate = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7562),
                            QuizId = 1,
                            Status = 6
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Bill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 4, 5, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7270),
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7278),
                            ...
                            StartDate = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7277),
                            Status = 5,
                            StoreID = 1,
                            TotalPrice = 500000m,
                            Type = 0
                        ...
                        new
                        {
                            ...
                            ContractorId = 1,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"),
                            EndDate = new DateTime(2023, 4, 5, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7378),
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7381),
                            Note = "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>",
                            StartDate = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7380),
                            Status = 5,
                            StoreID = 1,
            ...
            modelBuilder.Entity("Data.Entities.Builder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 415, DateTimeKind.Local).AddTicks(2066),
                            Place = 60,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 416, DateTimeKind.Local).AddTicks(8070),
                            Place = 61,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 423, DateTimeKind.Local).AddTicks(1486),
                            Place = 61,
            ...
            modelBuilder.Entity("Data.Entities.Color", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 6,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(6630),
                            Name = "Màu vàng"
                        },
                        new
                        {
                            Id = 7,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(6645),
                            Name = "Màu xám"
                        },
                        new
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7483),
                            Name = "No Color"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Contractor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"),
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 424, DateTimeKind.Local).AddTicks(8037)
                        },
                        new
                        {
                            Id = 2,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d6"),
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 426, DateTimeKind.Local).AddTicks(3974)
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.ContractorPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(5573),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(5855),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(5915),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            Description = "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>",
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(5941),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 20,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(5975),
                            NumberPeople = 30,
                            PeopeRemained = 0,
                            Place = 14,
                            PostCategories = 2,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(6004),
                            NumberPeople = 30,
                            PeopeRemained = 0,
                            Place = 14,
                            PostCategories = 2,
            ...
            modelBuilder.Entity("Data.Entities.MaterialStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 427, DateTimeKind.Local).AddTicks(9417),
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(4945)
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7438),
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7456),
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7470),
            ...
            modelBuilder.Entity("Data.Entities.Other", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7515),
                            Name = "No Other"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Products", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(6429),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(6733),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(6814),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(6916),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(6958),
                            MaterialStoreID = 1,
                            Name = "Ngói lợp",
                            SoldQuantities = 3000,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7000),
                            MaterialStoreID = 1,
                            Name = "Gạch lỗ",
                            SoldQuantities = 1500,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7014),
                            MaterialStoreID = 1,
                            Name = "Sơn chống thấm",
                            SoldQuantities = 1500,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7027),
                            MaterialStoreID = 1,
                            Name = "Cát Mịn",
                            SoldQuantities = 50,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7040),
                            MaterialStoreID = 2,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7053),
                            MaterialStoreID = 2,
                            Name = "Gạch 4 lỗ",
                            SoldQuantities = 2000,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7066),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7161),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7207),
                            MaterialStoreID = 1,
            ...
            modelBuilder.Entity("Data.Entities.ProductSize", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(6277),
                            Name = "4.5L"
                        },
                        new
                        {
                            Id = 3,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(6292),
                            Name = "7.5L"
                        },
                        new
                        {
                            Id = 4,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(6659),
                            Name = "5M"
                        },
                        new
                        {
                            Id = 5,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(6671),
                            Name = "10M"
                        },
                        new
                        {
                            Id = 7,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7113),
                            Name = "5L"
                        },
                        new
                        {
                            Id = 8,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7127),
                            Name = "18L"
                        },
                        new
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7495),
                            Name = "No Size"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Quiz", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7587),
                        ...
                        {
                            Id = 2,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 429, DateTimeKind.Local).AddTicks(7604),
            ...
            modelBuilder.Entity("Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "fa0012ea-746e-420f-a26c-6e0e1e0e7ae9",
                            Description = "Admin",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "c071b98a-3a8e-4773-b7f4-a769db0b706a",
                            Description = "User",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "9eded11e-76ef-48d2-a361-57535cde11e0",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "8ab072b0-7532-4b08-85dd-6af78528abd9",
                            Description = "Store",
                            Name = "Store",
            ...
            modelBuilder.Entity("Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BuilderId = 1,
                            ConcurrencyStamp = "deb8580c-9715-465c-8e1a-65f02fd213ac",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            FirstName = "Admin",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 411, DateTimeKind.Local).AddTicks(9967),
                            LastName = "Admin",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAELR5e2KOp0Qq+TYV+T2ZU76ML8sWRGLYisDc5O/Py1V3VoAeA/rokBL6kUWaK26YWQ==",
                        ...
                        new
                        {
                            ...
                            Avatar = "https://i1-giaitri.vnecdn.net/2013/08/15/DK-02756-1376528749.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=mX89l0q4HQgntQ5wJesOcw",
                            BuilderId = 1,
                            ConcurrencyStamp = "9865796f-74d8-4cd6-b1b6-5d9208aaded7",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Hoai Nam",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 413, DateTimeKind.Local).AddTicks(5796),
                            LastName = "Doan Vu",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAELvwZ0YSa+p9RCg7QvBLLq+uhqWw8yH9G2X6eohuK3CUWMrLXOK7O6z/JoY79TtSkw==",
                        ...
                        new
                        {
                            ...
                            BuilderId = 2,
                            ConcurrencyStamp = "3ca6f007-7e64-47f4-9b40-874391567435",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            FirstName = "Thinh",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 415, DateTimeKind.Local).AddTicks(2119),
                            LastName = "Nguyen Anh",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEBE4tw4j+jRfMf+k12Qp1pcLXNxAQ/PAaoCMO1xcvD54OFUmp+Nkh6Q7kFm1BlwDQw==",
                        ...
                        new
                        {
                            ...
                            Avatar = "https://scontent.fsgn5-3.fna.fbcdn.net/v/t1.6435-9/86186750_1329130013936346_7257030880831471616_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=174925&_nc_ohc=Z1GTPvzRt7wAX_WbRZ5&_nc_ht=scontent.fsgn5-3.fna&oh=00_AfAYtaD2dHE_84_-PSlDqLaeyBlH9zJ3b308pHcTWucCXw&oe=642552F2",
                            BuilderId = 3,
                            ConcurrencyStamp = "1948781b-712d-4d36-a809-da7ecf700acd",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Hieu",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 416, DateTimeKind.Local).AddTicks(8113),
                            LastName = "Nguyen Anh",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEENMilV86C4pyock0Y9L5eoN9iC6CRBQhG59bABGUqF6/s6WVM1+73qhbxhfPHyGQg==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "fe293377-281e-409a-878a-aeee75fd99ce",
                            ContractorId = 1,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 423, DateTimeKind.Local).AddTicks(1674),
                            LastName = "NSN",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAENx6ntvRYi1dNFMt38xkuYIkpn6DBz33rjv4ZOQJbaA0Z0MLwHiVOuZVjlR2WD/GeQ==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "1b9b77c9-a4bd-4857-a29c-ec87ec842311",
                            ContractorId = 2,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 424, DateTimeKind.Local).AddTicks(8062),
                            LastName = "Taseco",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAECrNaT7552TiISl2Q3RfzJCIH6eVpCYTkuM2ETVOhsdHfA/b4FFSW/F4psnGaeXY8A==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "e1896789-dcb6-4111-8e68-86eae19035dc",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "TPHCM",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 426, DateTimeKind.Local).AddTicks(3993),
                            LastName = "Cửa Hàng Vật Liệu",
                            LockoutEnabled = false,
                            MaterialStoreID = 1,
                            PasswordHash = "AQAAAAEAACcQAAAAEB2NiL20YLUOBSiOLi5Yzu0hxtUcHLDMwpPggLs67zWkA651O35TkJIjMnhNT04bRw==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "6c5f2d5f-0f33-4345-b8ba-ed7a41596a79",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Cần Thơ",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 31, 1, 427, DateTimeKind.Local).AddTicks(9438),
                            LastName = "VLXD",
                            LockoutEnabled = false,
                            MaterialStoreID = 2,
                            PasswordHash = "AQAAAAEAACcQAAAAEGOWORADElMynbuhT3rFHq3FDMDYFU06Sydlx7RtgQNbnTBv3oPIouI6ZzZDXQ7fSA==",
