    ...
    public partial class v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), null, null, new DateTime(2023, 2, 2, 11, 52, 8, 86, DateTimeKind.Local).AddTicks(6343), 60, null },
                    { 2, null, new Guid("d39ae0a6-9b2d-4421-be4a-cc294cec054f"), null, null, new DateTime(2023, 2, 2, 11, 52, 8, 92, DateTimeKind.Local).AddTicks(7239), 61, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"), null, new DateTime(2023, 2, 2, 11, 52, 8, 98, DateTimeKind.Local).AddTicks(7798), null },
                    { 2, null, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d6"), null, new DateTime(2023, 2, 2, 11, 52, 8, 104, DateTimeKind.Local).AddTicks(8209), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("20efd516-f16c-41b3-b11d-bc908cd2056b"), "124e5c2c-f794-4b54-bbe8-5dce3ccf944e", "Contractor", "Contractor", "CONTRACTOR" },
                    { new Guid("52ec6e78-6732-43bf-adab-9cfa2e5da268"), "9a78e3ab-1bc8-4ee3-ab79-de4b03270689", "Admin", "Admin", "ADMIN" },
                    { new Guid("a4fbc29e-9749-4ea0-bcaa-67fc9f104bd1"), "24508ddd-b640-47ea-a225-bacb79d61606", "Store", "Store", "STORE" },
                    { new Guid("dc48ba58-ddcb-41de-96fe-e41327e5f313"), "8d73145d-9419-4f10-9703-772ce739f802", "User", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Mỹ", null, "Sơn chống thấm Nippon", "https://nipponpaint.com.vn/sites/default/files/inline-images/son-chong-tham-la-gi-1.jpg", 1, "Sơn chống thấm", 1500, 2000, 1000000m },
                    { 4, "Việt Nam", null, "Cát mịn dành cho xây dựng", "https://sbshouse.vn/wp-content/uploads/2020/09/cat-xay-dung.jpg", 1, "Cát Mịn", 50, 200000, 100m },
                    { 5, "Việt Nam", null, "Xi măng Hà Tiên", "http://ximang.vn/Upload/48/Nam_2022/Thang_5/Ngay_31/ximang_vicemhatien1.jpg", 2, "Xi măng Hà Tiên", 300, 5000, 80000m },
                    ...
                    { 7, "Pháp", null, "Gạch hoa lát cổ điển, màu trắng đen tương thích với các kiến trúc cổ", "http://anhduongphat.vn/wp-content/uploads/2020/03/gach-bong-trang-tri-hoa-van.jpg", 1, "Gạch Hoa Cổ Điển", 1500, 30000, 50000m },
                    { 20, "Kangaroo", null, "Description 1", null, 1, "Product 1", 100, 1000, 4000m },
                    { 21, "Sony", null, "Description 2", null, 1, "Product 2", 1000, 1200, 5000m },
                    { 22, "Samsung", null, "Description 3", null, 1, "Product 3", 100, 100, 6000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("b57b172a-a044-11ed-a8fc-0242ac120002"), 0, "Q2", null, null, "132b5781-ff38-476a-8d1c-f5fd537a63c0", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "store@gmail.com", false, "Store", 0, null, new DateTime(2023, 2, 2, 11, 52, 8, 104, DateTimeKind.Local).AddTicks(8219), "Store", false, null, 1, null, null, "AQAAAAEAACcQAAAAEPO5V3FDmzTPrKluwavsLW1AqJ0hRAP6SpsODRaGS4Vpozt+vDgeOiqnD30piiUZxw==", "0924516734", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "0924516734", null },
                    { new Guid("be21b564-a044-11ed-a8fc-0242ac120002"), 0, "Q2", null, null, "b5edce3d-38a3-44e4-b30e-82d062c1b32e", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "store2@gmail.com", false, "Store2", 0, null, new DateTime(2023, 2, 2, 11, 52, 8, 111, DateTimeKind.Local).AddTicks(6082), "Store2", false, null, 2, null, null, "AQAAAAEAACcQAAAAEHWJxmv1FBQeyfzR+X/DUrD7cQcerlEvVAXMI2trurYaGwaDf0GQO/MAp5faH4OaPA==", "09245167342", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "09245167342", null },
                    { new Guid("d39ae0a6-9b2d-4421-be4a-cc294cec054f"), 0, "18, Phuoc Thien, Nhon Trach, Dong Nai", null, 2, "911a7e26-93b7-46c9-9509-afd5e40f085a", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "namhoaidoan1@gmail.com", false, "Thinh", 0, null, new DateTime(2023, 2, 2, 11, 52, 8, 86, DateTimeKind.Local).AddTicks(6359), "Nguyen", false, null, null, null, null, "AQAAAAEAACcQAAAAEEBI7yNDcwtXqxzyzJ+fiQBCeveFgl2WBCz+dB8kT2TEnETXxFoRalrB9y3oR/mH4Q==", "0937341639", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "namhoaidoan1@gmail.com", null },
                    { new Guid("d7285fb7-835b-4680-a18c-673bd71f63d6"), 0, "Q2", "https://www.vietnamworks.com/_next/image?url=https%3A%2F%2Fimages.vietnamworks.com%2Fpictureofcompany%2F69%2F11128477.png&w=128&q=75", null, "ba6a963a-a765-4b79-b021-02b78a5c7bc8", 2, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "contractor2@gmail.com", false, "Công Ty Cổ Phần Đầu Tư Bất Động Sản", 0, null, new DateTime(2023, 2, 2, 11, 52, 8, 98, DateTimeKind.Local).AddTicks(7829), "Taseco", false, null, null, null, null, "AQAAAAEAACcQAAAAECtsNTtlz4aN7iVtX1SvZoaHHmi29kNng2aWfb6U6DKZS6VAOT1wG7vdd7lni0dslw==", "09987654321", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "0987654321", null },
                    { new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"), 0, "Q2", "https://www.vietnamworks.com/_next/image?url=https%3A%2F%2Fimages.vietnamworks.com%2Fpictureofcompany%2F78%2F11127264.png&w=128&q=75", null, "767ea2ab-2efa-486f-9594-4986d93eb9d1", 1, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "contractor@gmail.com", false, "Công Ty Cổ Phần Xây Dựng Và Công Nghiệp", 0, null, new DateTime(2023, 2, 2, 11, 52, 8, 92, DateTimeKind.Local).AddTicks(7266), "NSN", false, null, null, null, null, "AQAAAAEAACcQAAAAEHMjGed88R+wQuEmIAfmAvAWCWLu2OQn1YgI5IUW/rVoZkYDyxbJTWwoseh3dqgCdg==", "0912345678", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "0912345678", null },
                    { new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), 0, "18, Phuoc Thien, Nhon Trach, Dong Nai", null, 1, "9f5a1060-aac2-485a-adc5-517eaaf2a472", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "namhoaidoan15@gmail.com", false, "Hoai", 0, null, new DateTime(2023, 2, 2, 11, 52, 8, 80, DateTimeKind.Local).AddTicks(6093), "Nam", false, null, null, null, null, "AQAAAAEAACcQAAAAELTU0Rt36jmtX8bGFj8Lh8pkMRsgxmaoHHYIx7L7rqGr7XrqXJDfe+TSk6kUNjtvUw==", "0879411575", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "namhoaidoan15@gmail.com", null }
                });
