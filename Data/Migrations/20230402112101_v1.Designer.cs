            ...
            modelBuilder.Entity("Data.Entities.AppliedPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PostID = 1,
                            BuilderID = 1,
                            AppliedDate = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3904),
                            QuizId = 1,
                            Status = 6
                        },
                        new
                        {
                            PostID = 1,
                            BuilderID = 2,
                            AppliedDate = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3921),
                            QuizId = 1,
                            Status = 6
                        },
                        new
                        {
                            PostID = 1,
                            BuilderID = 3,
                            AppliedDate = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3933),
                            QuizId = 1,
                            Status = 6
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Bill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 4, 7, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3663),
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3670),
                            ...
                            StartDate = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3669),
                            Status = 5,
                            StoreID = 1,
                            TotalPrice = 500000m,
                            Type = 0
                        ...
                        new
                        {
                            ...
                            ContractorId = 1,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"),
                            EndDate = new DateTime(2023, 4, 7, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3743),
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3745),
                            Note = "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>",
                            StartDate = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3744),
                            Status = 5,
                            StoreID = 1,
            ...
            modelBuilder.Entity("Data.Entities.Builder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 41, DateTimeKind.Local).AddTicks(6792),
                            Place = 60,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 43, DateTimeKind.Local).AddTicks(2649),
                            Place = 61,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 44, DateTimeKind.Local).AddTicks(8770),
                            Place = 61,
            ...
            modelBuilder.Entity("Data.Entities.Color", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 6,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(2946),
                            Name = "Màu vàng"
                        },
                        new
                        {
                            Id = 7,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(2980),
                            Name = "Màu xám"
                        },
                        new
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3850),
                            Name = "No Color"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Contractor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"),
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 46, DateTimeKind.Local).AddTicks(4424)
                        },
                        new
                        {
                            Id = 2,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d6"),
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 48, DateTimeKind.Local).AddTicks(116)
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.ContractorPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(1893),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(1988),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(2055),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            Description = "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>",
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(2191),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 20,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(2232),
                            NumberPeople = 30,
                            PeopeRemained = 0,
                            Place = 14,
                            PostCategories = 2,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(2263),
                            NumberPeople = 30,
                            PeopeRemained = 0,
                            Place = 14,
                            PostCategories = 2,
            ...
            modelBuilder.Entity("Data.Entities.MaterialStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 49, DateTimeKind.Local).AddTicks(5689),
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(1670)
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3804),
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3821),
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3836),
            ...
            modelBuilder.Entity("Data.Entities.Other", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3883),
                            Name = "No Other"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Products", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(2702),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3074),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3127),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3271),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3319),
                            MaterialStoreID = 1,
                            Name = "Ngói lợp",
                            SoldQuantities = 3000,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3334),
                            MaterialStoreID = 1,
                            Name = "Gạch lỗ",
                            SoldQuantities = 1500,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3348),
                            MaterialStoreID = 1,
                            Name = "Sơn chống thấm",
                            SoldQuantities = 1500,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3363),
                            MaterialStoreID = 1,
                            Name = "Cát Mịn",
                            SoldQuantities = 50,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3377),
                            MaterialStoreID = 2,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3391),
                            MaterialStoreID = 2,
                            Name = "Gạch 4 lỗ",
                            SoldQuantities = 2000,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3406),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3510),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3591),
                            MaterialStoreID = 1,
            ...
            modelBuilder.Entity("Data.Entities.ProductSize", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(2538),
                            Name = "4.5L"
                        },
                        new
                        {
                            Id = 3,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(2555),
                            Name = "7.5L"
                        },
                        new
                        {
                            Id = 4,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(2994),
                            Name = "5M"
                        },
                        new
                        {
                            Id = 5,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3007),
                            Name = "10M"
                        },
                        new
                        {
                            Id = 7,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3458),
                            Name = "5L"
                        },
                        new
                        {
                            Id = 8,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3473),
                            Name = "18L"
                        },
                        new
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3863),
                            Name = "No Size"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Quiz", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(3987),
                        ...
                        {
                            Id = 2,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 51, DateTimeKind.Local).AddTicks(4006),
            ...
            modelBuilder.Entity("Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "850d412e-a6a4-4998-8644-3c1824bd8661",
                            Description = "Admin",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "f059c2a6-78aa-48f6-940e-aa1bbf88987b",
                            Description = "User",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "39357fb8-2bb8-4a2e-9193-7291044a19b5",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "7545b5bf-0a38-4a34-8834-d36c79c5922e",
                            Description = "Store",
                            Name = "Store",
            ...
            modelBuilder.Entity("Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BuilderId = 1,
                            ConcurrencyStamp = "08003b93-36e4-4858-bb2f-6e57007f7eed",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            FirstName = "Admin",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 38, DateTimeKind.Local).AddTicks(4289),
                            LastName = "Admin",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAENNi9E+TJTh6F7ZARJqcU7buOwW8c7T1+DYL/Ih8OWnx1jB6j2O63n4Cy25m99dOYQ==",
                        ...
                        new
                        {
                            ...
                            Avatar = "https://i1-giaitri.vnecdn.net/2013/08/15/DK-02756-1376528749.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=mX89l0q4HQgntQ5wJesOcw",
                            BuilderId = 1,
                            ConcurrencyStamp = "62bb4344-a399-420b-8ff1-dcba42113f4f",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Hoai Nam",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 40, DateTimeKind.Local).AddTicks(652),
                            LastName = "Doan Vu",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEGlV3hbaw7Zm3RwD5n/92gkxlO9/f2nISbQ+3bY+OKdb4S5WCjUrMqisxkoSOtTWsQ==",
                        ...
                        new
                        {
                            ...
                            BuilderId = 2,
                            ConcurrencyStamp = "d7ce0cdd-1d50-4fca-9355-9988a2cf2927",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            FirstName = "Thinh",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 41, DateTimeKind.Local).AddTicks(6866),
                            LastName = "Nguyen Anh",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEN4Pjesxkh74Lth6oscELvmymBWqBaAEJle/rY5kKEVRepwrmQUBVpRRbwWWM6M++g==",
                        ...
                        new
                        {
                            ...
                            Avatar = "https://scontent.fsgn5-3.fna.fbcdn.net/v/t1.6435-9/86186750_1329130013936346_7257030880831471616_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=174925&_nc_ohc=Z1GTPvzRt7wAX_WbRZ5&_nc_ht=scontent.fsgn5-3.fna&oh=00_AfAYtaD2dHE_84_-PSlDqLaeyBlH9zJ3b308pHcTWucCXw&oe=642552F2",
                            BuilderId = 3,
                            ConcurrencyStamp = "6e0d141f-794a-4770-8969-63129a6d7e75",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Hieu",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 43, DateTimeKind.Local).AddTicks(2842),
                            LastName = "Nguyen Anh",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEEDWWDBRkac0MV7RVJHcXqXlJZGgDGV7XByTuyyUHhk3XNGLRH2d1CziHgpPAZSCGQ==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "40b5a7cd-ec2a-45cd-ab0d-eee1f8450691",
                            ContractorId = 1,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 44, DateTimeKind.Local).AddTicks(8845),
                            LastName = "NSN",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEPNZXylUn1+DIZqGeeDi2vdehstrQTNeka/bf8ED+tpCMYxnW8FP8ufGORlcXNEY/Q==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "fbc9b07e-85b0-4409-a7e3-f1f8a6c312ed",
                            ContractorId = 2,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 46, DateTimeKind.Local).AddTicks(4445),
                            LastName = "Taseco",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEImkhbOt0TGWR1KTh39cBK3Sy9JCfewQR9MZZF0GEpWyKwJwoPwkN+/i8DRcK58rog==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "2fd5e015-ab68-47be-aec7-66d75fd4d50d",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "TPHCM",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 48, DateTimeKind.Local).AddTicks(166),
                            LastName = "Cửa Hàng Vật Liệu",
                            LockoutEnabled = false,
                            MaterialStoreID = 1,
                            PasswordHash = "AQAAAAEAACcQAAAAEEJcIU2prOwPCoY4LZfqkM4Wb2WsIiZpGqJWclQIbQIgvz2J5X26LTA70KLp3LJuFQ==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "ab403de7-c0c9-4284-a063-9f636b8ba988",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Cần Thơ",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 2, 18, 21, 1, 49, DateTimeKind.Local).AddTicks(5736),
                            LastName = "VLXD",
                            LockoutEnabled = false,
                            MaterialStoreID = 2,
                            PasswordHash = "AQAAAAEAACcQAAAAEBbYTBbvESMkXQOGgs6qFn5edFRHbD2Md+tJfXaF0ikNjHLqu/NHcEyr4V7PKfJmWg==",
