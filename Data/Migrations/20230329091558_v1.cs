    ...
    public partial class v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3791), "No Color" },
                    { 6, null, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(2973), "Màu vàng" },
                    { 7, null, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(2988), "Màu xám" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"), null, new DateTime(2023, 3, 29, 16, 15, 57, 830, DateTimeKind.Local).AddTicks(5237), null },
                    { 2, null, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d6"), null, new DateTime(2023, 3, 29, 16, 15, 57, 832, DateTimeKind.Local).AddTicks(715), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new Guid("b57b172a-a044-11ed-a8fc-0242ac120002"), "Với mục tiêu cung cấp nhiều gói sản phẩm phong phú về mẫu mã và các tính năng linh hoạt cho nhiều loại hình website như giới thiệu công ty, bán hàng, trang tin tức, thương mại điện tử… cùng với nhiều giao diện phong phú đa dạng độc đáo đã được VNS lọc chọn và đúc kết nhằm giới thiệu tới khách hàng với mong muốn có một website nhanh, đẹp, hiệu quả và giá cả hợp lý.", null, null, new DateTime(2023, 3, 29, 16, 15, 57, 833, DateTimeKind.Local).AddTicks(6483), null, null, "https://vinasoftware.com.vn/" },
                    { 2, new Guid("be21b564-a044-11ed-a8fc-0242ac120002"), null, null, null, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(1930), null, null, null }
                });

            migrationBuilder.InsertData(
                table: "Other",
                columns: new[] { "Id", "Image", "LastModifiedAt", "Name" },
                values: new object[] { 1, null, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3822), "No Other" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("20efd516-f16c-41b3-b11d-bc908cd2056b"), "9d53b4ec-6ff0-4b2e-8018-5902c75e5be8", "Contractor", "Contractor", "CONTRACTOR" },
                    { new Guid("52ec6e78-6732-43bf-adab-9cfa2e5da268"), "cb616416-7278-44c3-bf2b-3bfe47096394", "Admin", "Admin", "ADMIN" },
                    { new Guid("a4fbc29e-9749-4ea0-bcaa-67fc9f104bd1"), "461250c6-b41b-478b-8425-e7a52de5e266", "Store", "Store", "STORE" },
                    { new Guid("dc48ba58-ddcb-41de-96fe-e41327e5f313"), "d5d3cfec-b8b6-4fc3-ad9d-45afc494b91d", "User", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3804), "No Size" },
                    { 2, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(2612), "4.5L" },
                    { 3, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(2627), "7.5L" },
                    { 4, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3001), "5M" },
                    { 5, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3013), "10M" },
                    { 7, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3429), "5L" },
                    { 8, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3442), "18L" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("d7285fb7-835b-4680-a18c-673bd71f63e9"), 0, "18, Phuoc Thien, Nhon Trach, Dong Nai", "https://i1-giaitri.vnecdn.net/2013/08/15/DK-02756-1376528749.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=mX89l0q4HQgntQ5wJesOcw", null, "36347e9f-aaa5-4234-baa3-cd27c10fc752", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin15@gmail.com", false, "Admin", 0, null, new DateTime(2023, 3, 29, 16, 15, 57, 822, DateTimeKind.Local).AddTicks(6322), "Admin", false, null, null, null, null, "AQAAAAEAACcQAAAAEGzz7ZcOhNchXn6bRWWQj9CUKY9gD/rssY7GNdiaIDBhot6Bxd+WgIlRpnkvMnjIig==", "0909090909", false, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "admin15@gmail.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"), new DateTime(2023, 4, 3, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3620), new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3626), "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>", null, null, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3625), 5, 1, 500000m, 0 },
                    { 2, 1, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"), new DateTime(2023, 4, 3, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3687), new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3689), "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>", null, null, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3688), 5, 1, 60000000m, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, null, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), null, null, null, new DateTime(2023, 3, 29, 16, 15, 57, 825, DateTimeKind.Local).AddTicks(7571), 60, new Guid("4ace8fcb-95eb-48c0-9deb-240e8b4e10e0") },
                    { 2, null, null, new Guid("d39ae0a6-9b2d-4421-be4a-cc294cec054f"), null, null, null, new DateTime(2023, 3, 29, 16, 15, 57, 827, DateTimeKind.Local).AddTicks(3750), 61, new Guid("bd880489-5c76-4854-93ab-66e3a541bf24") },
                    { 3, null, null, new Guid("d91f9ece-25a7-4dc6-adde-186b12c04d56"), null, null, null, new DateTime(2023, 3, 29, 16, 15, 57, 828, DateTimeKind.Local).AddTicks(9323), 61, new Guid("ce9fa65b-d005-46b6-953e-e6462a59cfb3") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Pháp", new Guid("00000000-0000-0000-0000-000000000000"), null, "Ngói lợp kiểu Pháp cổ điển", "https://sbo.vn/wp-content/uploads/2021/06/tam-lop-sinh-thai-onduline.jpg", new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3303), 1, "Ngói lợp", 3000, true, "ton", 300000, 700m },
                    { 2, "Việt Nam", new Guid("00000000-0000-0000-0000-000000000000"), null, "Gạch 2 lỗ cao cấp đến từ thương hiệu nổi tiếng ", "http://www.phudien.vn/upload/Product%20400x200/G%E1%BA%A1ch%20tuynel%20-%20g%E1%BA%A1ch%206%20l%E1%BB%97%20lo%E1%BA%A1i%20nh%E1%BB%8F.png", new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3316), 1, "Gạch lỗ", 1500, true, "ton", 300000, 40000m },
                    { 3, "Mỹ", new Guid("00000000-0000-0000-0000-000000000000"), null, "Sơn chống thấm Nippon", "https://nipponpaint.com.vn/sites/default/files/inline-images/son-chong-tham-la-gi-1.jpg", new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3329), 1, "Sơn chống thấm", 1500, true, "ton", 2000, 1000000m },
                    { 4, "Việt Nam", new Guid("00000000-0000-0000-0000-000000000000"), null, "Cát mịn dành cho xây dựng đặc biệt dành cho ngôi nhà yêu dấu của bạn", "https://sbshouse.vn/wp-content/uploads/2020/09/cat-xay-dung.jpg", new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3342), 1, "Cát Mịn", 50, true, "ton", 200000, 50000m },
                    { 5, "Việt Nam", new Guid("00000000-0000-0000-0000-000000000000"), null, "Xi măng Hà Tiên", "http://ximang.vn/Upload/48/Nam_2022/Thang_5/Ngay_31/ximang_vicemhatien1.jpg", new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3355), 2, "Xi măng Hà Tiên", 300, true, "ton", 5000, 80000m },
                    { 6, "Việt Nam", new Guid("00000000-0000-0000-0000-000000000000"), null, "Gạch 4 lỗ", "https://imgcdn9h.store123doc.com/article/2019_1_w4/508-gach-4-lo-nua-duoc-su-dung-cung-voi-gach-4-lo-nguyen-de-xay-nha.jpeg", new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3368), 2, "Gạch 4 lỗ", 2000, true, "ton", 500000, 700000m },
                    ...
                    { 38, "NIRO GRANITE", new Guid("00000000-0000-0000-0000-000000000000"), null, "GHR Gạch Granite Hardrock Mờ/Bán bóng ", "https://admin.mingstores.com/core/public/themes/mingstores/products/6TauBDiJiwnvQaJTuCl9D0SYHFayTRHk.jpg", new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3259), 1, "GHR Gạch Granite Hardrock Mờ/Bán bóng", 1500, true, "Viên", 200, 360000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), false, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3748), "Someone has saved your post", 1, "New Notification", 0, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7") },
                    { 2, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), false, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3765), "Someone has applied your post", 1, "New Notification", 0, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7") },
                    { 3, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), false, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3779), "Create commitment successfully", 1, "New Notification", 0, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3887), "Bài test thợ xây ", 1, new Guid("4ace8fcb-95eb-48c0-9deb-240e8b4e10e0") },
                    { 2, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3907), "Bài test thợ sơn ", 1, new Guid("ce9fa65b-d005-46b6-953e-e6462a59cfb3") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d39ae0a6-9b2d-4421-be4a-cc294cec054f"), 0, "18, Phuoc Thien, Nhon Trach, Dong Nai", "https://scontent.fsgn5-3.fna.fbcdn.net/v/t1.6435-9/86186750_1329130013936346_7257030880831471616_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=174925&_nc_ohc=Z1GTPvzRt7wAX_WbRZ5&_nc_ht=scontent.fsgn5-3.fna&oh=00_AfAYtaD2dHE_84_-PSlDqLaeyBlH9zJ3b308pHcTWucCXw&oe=642552F2", 2, "481a1b3b-4821-457b-ba7e-a887cf519b21", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "namhoaidoan1@gmail.com", false, "Thinh", 0, null, new DateTime(2023, 3, 29, 16, 15, 57, 825, DateTimeKind.Local).AddTicks(7630), "Nguyen Anh", false, null, null, null, null, "AQAAAAEAACcQAAAAEA+sVrj3QmkoUvVfR2Dw4AiUoUila6Bi039z0NvJO0L0Z8cb7rTK4kN4SGZI5Dk4Uw==", "0937341639", false, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "namhoaidoan1@gmail.com" },
                    { new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), 0, "18, Phuoc Thien, Nhon Trach, Dong Nai", "https://i1-giaitri.vnecdn.net/2013/08/15/DK-02756-1376528749.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=mX89l0q4HQgntQ5wJesOcw", 1, "def41368-c39c-4ccf-95ef-8956817acb4d", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "namhoaidoan15@gmail.com", false, "Hoai Nam", 0, null, new DateTime(2023, 3, 29, 16, 15, 57, 824, DateTimeKind.Local).AddTicks(2036), "Doan Vu", false, null, null, null, null, "AQAAAAEAACcQAAAAEIzmNyO3+y+DwY8dXCutmhmTiM0ZE7uIFFH0PmRBbemKFjLbw9XNvLfDrwCPju9FQQ==", "0879411575", false, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "namhoaidoan15@gmail.com" },
                    { new Guid("d91f9ece-25a7-4dc6-adde-186b12c04d56"), 0, "18, Phuoc Thien, Nhon Trach, Dong Nai", "https://scontent.fsgn5-3.fna.fbcdn.net/v/t1.6435-9/86186750_1329130013936346_7257030880831471616_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=174925&_nc_ohc=Z1GTPvzRt7wAX_WbRZ5&_nc_ht=scontent.fsgn5-3.fna&oh=00_AfAYtaD2dHE_84_-PSlDqLaeyBlH9zJ3b308pHcTWucCXw&oe=642552F2", 3, "cf6c8d97-47e8-4675-bd9c-22c005bd6235", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "namhoaidoan12@gmail.com", false, "Hieu", 0, null, new DateTime(2023, 3, 29, 16, 15, 57, 827, DateTimeKind.Local).AddTicks(3791), "Nguyen Anh", false, null, null, null, null, "AQAAAAEAACcQAAAAELMufpgHaEufV9VwJ7pLrOrCm/7f5rjajlodUR48+c2UQZAHXm8f1XsD1l4ocWlQfA==", "0101010101", false, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "namhoaidoan12@gmail.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3840), null, 1, 6, null },
                    { 2, 1, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3854), null, 1, 6, null },
                    { 3, 1, new DateTime(2023, 3, 29, 16, 15, 57, 835, DateTimeKind.Local).AddTicks(3866), null, 1, 6, null }
                });
