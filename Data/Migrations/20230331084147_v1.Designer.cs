            ...
            modelBuilder.Entity("Data.Entities.AppliedPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PostID = 1,
                            BuilderID = 1,
                            AppliedDate = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1263),
                            QuizId = 1,
                            Status = 6
                        },
                        new
                        {
                            PostID = 1,
                            BuilderID = 2,
                            AppliedDate = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1282),
                            QuizId = 1,
                            Status = 6
                        },
                        new
                        {
                            PostID = 1,
                            BuilderID = 3,
                            AppliedDate = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1297),
                            QuizId = 1,
                            Status = 6
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Bill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 4, 5, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1002),
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1008),
                            ...
                            StartDate = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1007),
                            Status = 5,
                            StoreID = 1,
                            TotalPrice = 500000m,
                            Type = 0
                        ...
                        new
                        {
                            ...
                            ContractorId = 1,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"),
                            EndDate = new DateTime(2023, 4, 5, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1084),
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1086),
                            Note = "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>",
                            StartDate = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1085),
                            Status = 5,
                            StoreID = 1,
            ...
            modelBuilder.Entity("Data.Entities.Builder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 518, DateTimeKind.Local).AddTicks(1925),
                            Place = 60,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 519, DateTimeKind.Local).AddTicks(8180),
                            Place = 61,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 521, DateTimeKind.Local).AddTicks(4813),
                            Place = 61,
            ...
            modelBuilder.Entity("Data.Entities.Color", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 6,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(142),
                            Name = "Màu vàng"
                        },
                        new
                        {
                            Id = 7,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(177),
                            Name = "Màu xám"
                        },
                        new
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1207),
                            Name = "No Color"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Contractor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"),
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 523, DateTimeKind.Local).AddTicks(958)
                        },
                        new
                        {
                            Id = 2,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d6"),
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 524, DateTimeKind.Local).AddTicks(6951)
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.ContractorPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 527, DateTimeKind.Local).AddTicks(9030),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 527, DateTimeKind.Local).AddTicks(9133),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 527, DateTimeKind.Local).AddTicks(9212),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            Description = "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>",
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 527, DateTimeKind.Local).AddTicks(9341),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 20,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 527, DateTimeKind.Local).AddTicks(9390),
                            NumberPeople = 30,
                            PeopeRemained = 0,
                            Place = 14,
                            PostCategories = 2,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 527, DateTimeKind.Local).AddTicks(9427),
                            NumberPeople = 30,
                            PeopeRemained = 0,
                            Place = 14,
                            PostCategories = 2,
            ...
            modelBuilder.Entity("Data.Entities.MaterialStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 526, DateTimeKind.Local).AddTicks(2634),
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 527, DateTimeKind.Local).AddTicks(8784)
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1154),
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1173),
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1191),
            ...
            modelBuilder.Entity("Data.Entities.Other", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1243),
                            Name = "No Other"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Products", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 527, DateTimeKind.Local).AddTicks(9886),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(286),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(346),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(504),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(559),
                            MaterialStoreID = 1,
                            Name = "Ngói lợp",
                            SoldQuantities = 3000,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(575),
                            MaterialStoreID = 1,
                            Name = "Gạch lỗ",
                            SoldQuantities = 1500,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(592),
                            MaterialStoreID = 1,
                            Name = "Sơn chống thấm",
                            SoldQuantities = 1500,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(608),
                            MaterialStoreID = 1,
                            Name = "Cát Mịn",
                            SoldQuantities = 50,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(624),
                            MaterialStoreID = 2,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(640),
                            MaterialStoreID = 2,
                            Name = "Gạch 4 lỗ",
                            SoldQuantities = 2000,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(656),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(783),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(910),
                            MaterialStoreID = 1,
            ...
            modelBuilder.Entity("Data.Entities.ProductSize", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 527, DateTimeKind.Local).AddTicks(9703),
                            Name = "4.5L"
                        },
                        new
                        {
                            Id = 3,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 527, DateTimeKind.Local).AddTicks(9721),
                            Name = "7.5L"
                        },
                        new
                        {
                            Id = 4,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(194),
                            Name = "5M"
                        },
                        new
                        {
                            Id = 5,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(209),
                            Name = "10M"
                        },
                        new
                        {
                            Id = 7,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(719),
                            Name = "5L"
                        },
                        new
                        {
                            Id = 8,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(736),
                            Name = "18L"
                        },
                        new
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1222),
                            Name = "No Size"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Quiz", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1351),
                        ...
                        {
                            Id = 2,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 528, DateTimeKind.Local).AddTicks(1371),
            ...
            modelBuilder.Entity("Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "ab6631fa-09b3-4d48-a462-a37a30791cb1",
                            Description = "Admin",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "33c33a63-b8ae-4867-9229-0919d76259c8",
                            Description = "User",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "c925c4b1-c582-4e85-a464-98d28f14969d",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "16a66479-595f-47b4-b7b3-55ab4830f3e3",
                            Description = "Store",
                            Name = "Store",
            ...
            modelBuilder.Entity("Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BuilderId = 1,
                            ConcurrencyStamp = "a225562a-96ed-4deb-8438-56950543ab40",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            FirstName = "Admin",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 514, DateTimeKind.Local).AddTicks(9450),
                            LastName = "Admin",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAELLKAEcxPar4+69GFX5+smgWwR8a1T9oiRlW8KMzZ+6xRLXTpNWcIPssTENG1QPMZA==",
                        ...
                        new
                        {
                            ...
                            Avatar = "https://i1-giaitri.vnecdn.net/2013/08/15/DK-02756-1376528749.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=mX89l0q4HQgntQ5wJesOcw",
                            BuilderId = 1,
                            ConcurrencyStamp = "8fb256e2-345b-464a-84e3-7a8976af1e6e",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Hoai Nam",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 516, DateTimeKind.Local).AddTicks(5651),
                            LastName = "Doan Vu",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEIfWLXbsDfcw40/6Q5YRm98wUOp64n+82F0S+v3W2hcCRX6VveS2XKdY99cAoyj9sQ==",
                        ...
                        new
                        {
                            ...
                            BuilderId = 2,
                            ConcurrencyStamp = "4aa1ba17-fe53-4f4f-961b-60f0dcf51c7f",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            FirstName = "Thinh",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 518, DateTimeKind.Local).AddTicks(2009),
                            LastName = "Nguyen Anh",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEBFUe+rWd2TObPYJSkxNex18LQpJHVZDKQFGDIp7dVAGPjja3AobCoKx1+Jd/fBnqA==",
                        ...
                        new
                        {
                            ...
                            Avatar = "https://scontent.fsgn5-3.fna.fbcdn.net/v/t1.6435-9/86186750_1329130013936346_7257030880831471616_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=174925&_nc_ohc=Z1GTPvzRt7wAX_WbRZ5&_nc_ht=scontent.fsgn5-3.fna&oh=00_AfAYtaD2dHE_84_-PSlDqLaeyBlH9zJ3b308pHcTWucCXw&oe=642552F2",
                            BuilderId = 3,
                            ConcurrencyStamp = "fe633eaa-3d0f-4a88-80de-eef907762ff2",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Hieu",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 519, DateTimeKind.Local).AddTicks(8467),
                            LastName = "Nguyen Anh",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEOxgFbnEb2H30CLPo/7+Z2kbvPvSxDo0M6zfIAwHlzMyhmFscHxnLKbZlh/QcoNepw==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "848f57db-af47-4976-ae9b-b337594d5713",
                            ContractorId = 1,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 521, DateTimeKind.Local).AddTicks(4887),
                            LastName = "NSN",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEAR8YlqkSCDS9UfliVMbRkbNJ1r8L22WLdKvldyxBpAHqdXqRU6Vnksn3/vW3wjCzw==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "ac610863-b69a-4d8e-8360-c321c7450832",
                            ContractorId = 2,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 523, DateTimeKind.Local).AddTicks(986),
                            LastName = "Taseco",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEFOtusT8PrS8+zb2BhUH+r9b7cdTHlRI5aguzU6Qz9aIkFVvprVHIyuVxRGV7hd5pA==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "3871e05c-9100-4e0b-a5e5-9964388eb294",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "TPHCM",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 524, DateTimeKind.Local).AddTicks(6992),
                            LastName = "Cửa Hàng Vật Liệu",
                            LockoutEnabled = false,
                            MaterialStoreID = 1,
                            PasswordHash = "AQAAAAEAACcQAAAAELFjgaR0ZuMCKmepyGOJBZVdvaaZlqX0OakpEUyz/ifSdrk4CuxZ0XPBhW3sP6Dzkw==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "0096be9f-e904-406b-b6c2-e1f69904dc8b",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Cần Thơ",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 15, 41, 46, 526, DateTimeKind.Local).AddTicks(2692),
                            LastName = "VLXD",
                            LockoutEnabled = false,
                            MaterialStoreID = 2,
                            PasswordHash = "AQAAAAEAACcQAAAAEPrucwIohpQKUE013Cnm1wBrMKS8x2lK/tHVf57Ksn3+jtWQ9tTUC9W+L9dzkdyYyQ==",
