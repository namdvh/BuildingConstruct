            ...
            modelBuilder.Entity("Data.Entities.Bill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 3, 18, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3867),
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3873),
                            ...
                            StartDate = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3873),
                            Status = 5,
                            StoreID = 1,
                            TotalPrice = 500000m,
                            Type = 0
                        ...
                        new
                        {
                            ...
                            ContractorId = 1,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"),
                            EndDate = new DateTime(2023, 3, 18, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3927),
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3929),
                            Note = "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>",
                            StartDate = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3928),
                            Status = 5,
                            StoreID = 1,
            ...
            modelBuilder.Entity("Data.Entities.Builder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 455, DateTimeKind.Local).AddTicks(7770),
                            Place = 60
                        },
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 464, DateTimeKind.Local).AddTicks(1099),
                            Place = 61
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Contractor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"),
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 472, DateTimeKind.Local).AddTicks(4408)
                        },
                        new
                        {
                            Id = 2,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d6"),
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 480, DateTimeKind.Local).AddTicks(7323)
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.ContractorPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(2873),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(2918),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(2957),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            Description = "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>",
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(2979),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 20,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3007),
                            NumberPeople = 30,
                            PeopeRemained = 0,
                            Place = 14,
                            PostCategories = 2,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3028),
                            NumberPeople = 30,
                            PeopeRemained = 0,
                            Place = 14,
                            PostCategories = 2,
            ...
            modelBuilder.Entity("Data.Entities.MaterialStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 488, DateTimeKind.Local).AddTicks(9862),
                            Place = 0,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(2642),
                            Place = 0
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3991),
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(4006),
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(4022),
            ...
            modelBuilder.Entity("Data.Entities.Products", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3309),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3498),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3536),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3618),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3653),
                            MaterialStoreID = 1,
                            Name = "Ngói lợp",
                            SoldQuantities = 3000,
                            Unit = "ton",
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3664),
                            MaterialStoreID = 1,
                            Name = "Gạch lỗ",
                            SoldQuantities = 1500,
                            Unit = "ton",
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3674),
                            MaterialStoreID = 1,
                            Name = "Sơn chống thấm",
                            SoldQuantities = 1500,
                            Unit = "ton",
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3684),
                            MaterialStoreID = 1,
                            Name = "Cát Mịn",
                            SoldQuantities = 50,
                            Unit = "ton",
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3694),
                            MaterialStoreID = 2,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3706),
                            MaterialStoreID = 2,
                            Name = "Gạch 4 lỗ",
                            SoldQuantities = 2000,
                            Unit = "ton",
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3716),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3779),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 497, DateTimeKind.Local).AddTicks(3816),
                            MaterialStoreID = 1,
            ...
            modelBuilder.Entity("Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "0a73cf6e-240e-4abb-84ec-a40d007054d9",
                            Description = "Admin",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "96e2c0e5-e59b-407d-aa9d-bfb75e2328f7",
                            Description = "User",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "e1dc74fe-08f5-4c5b-8fbe-bfedb1ca2674",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "9b4fccb4-f4cf-4633-ba6a-a9ca7d28d4e8",
                            Description = "Store",
                            Name = "Store",
            ...
            modelBuilder.Entity("Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BuilderId = 1,
                            ConcurrencyStamp = "675061f2-f3d6-402c-b30e-1fff0268ac00",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            FirstName = "Hoai Nam",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 447, DateTimeKind.Local).AddTicks(4659),
                            LastName = "Doan Vu",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEBf36pC7bVAGdBPx2PjHW2mT8rbNJ7QspwFWFeiIPjwxHzv2tVLc8vwiIorShUdD4Q==",
                        ...
                        new
                        {
                            ...
                            BuilderId = 2,
                            ConcurrencyStamp = "b38d867b-2991-4099-b1a5-f4f9440c9a41",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            FirstName = "Thinh",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 455, DateTimeKind.Local).AddTicks(7827),
                            LastName = "Nguyen Anh",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEEEi8ifyXj3EqdgpLtEjPQQbWJ1q4vWw1XejfetqhLCgRY1eFHeoWDvwk9vKFtbB2g==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "6e4f461b-8102-46f4-ad4c-2dbe19123715",
                            ContractorId = 1,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 464, DateTimeKind.Local).AddTicks(1165),
                            LastName = "NSN",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAED3FQwTuVYLOrtqewgE8W2oqPRYtl92zS7kkY96AdkNz4W5RpOV15JqOa5yahotxBA==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b59cbc39-4c44-459a-a2fd-9fe576d609d9",
                            ContractorId = 2,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 472, DateTimeKind.Local).AddTicks(4439),
                            LastName = "Taseco",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEMhQofswrpOZ6VV+5r3VGiZQJqC1ckR+qO+HTo6aBQP9olux6C1k435m0dcZHiiRUQ==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "1d057e11-2487-491f-a5e8-d800adf7a6e8",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "TPHCM",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 480, DateTimeKind.Local).AddTicks(7337),
                            LastName = "Cửa Hàng Vật Liệu",
                            LockoutEnabled = false,
                            MaterialStoreID = 1,
                            PasswordHash = "AQAAAAEAACcQAAAAEH7UUlzOlEkuwQGBYkusXbeDvM53Kcl2bucN2Qg3WcrgTqWf7UobVPnEbZQos59ffw==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "79fe669d-473e-4289-bb8b-a37c61f65e09",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Cần Thơ",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 13, 21, 1, 26, 488, DateTimeKind.Local).AddTicks(9880),
                            LastName = "VLXD",
                            LockoutEnabled = false,
                            MaterialStoreID = 2,
                            PasswordHash = "AQAAAAEAACcQAAAAEBHWefesvXIklQ2WBDalE4RUvTgmz361apCLuxnMMbgpf0xIo3MWIT7+YJyZA3eUgA==",
