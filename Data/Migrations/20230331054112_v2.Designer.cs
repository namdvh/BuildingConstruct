            ...
            modelBuilder.Entity("Data.Entities.AppliedPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PostID = 1,
                            BuilderID = 1,
                            AppliedDate = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3354),
                            QuizId = 1,
                            Status = 6
                        },
                        new
                        {
                            PostID = 1,
                            BuilderID = 2,
                            AppliedDate = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3368),
                            QuizId = 1,
                            Status = 6
                        },
                        new
                        {
                            PostID = 1,
                            BuilderID = 3,
                            AppliedDate = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3377),
                            QuizId = 1,
                            Status = 6
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Bill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 4, 5, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3168),
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3174),
                            ...
                            StartDate = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3174),
                            Status = 5,
                            StoreID = 1,
                            TotalPrice = 500000m,
                            Type = 0
                        ...
                        new
                        {
                            ...
                            ContractorId = 1,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"),
                            EndDate = new DateTime(2023, 4, 5, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3224),
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3226),
                            Note = "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>",
                            StartDate = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3226),
                            Status = 5,
                            StoreID = 1,
            ...
            modelBuilder.Entity("Data.Entities.Builder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 776, DateTimeKind.Local).AddTicks(2396),
                            Place = 60,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 784, DateTimeKind.Local).AddTicks(5859),
                            Place = 61,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 792, DateTimeKind.Local).AddTicks(8520),
                            Place = 61,
            ...
            modelBuilder.Entity("Data.Entities.Color", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 6,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2552),
                            Name = "Màu vàng"
                        },
                        new
                        {
                            Id = 7,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2575),
                            Name = "Màu xám"
                        },
                        new
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3305),
                            Name = "No Color"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Contractor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"),
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 801, DateTimeKind.Local).AddTicks(1939)
                        },
                        new
                        {
                            Id = 2,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d6"),
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 809, DateTimeKind.Local).AddTicks(4350)
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.ContractorPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(286),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(333),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(370),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            Description = "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>",
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(391),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 20,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(1900),
                            NumberPeople = 30,
                            PeopeRemained = 0,
                            Place = 14,
                            PostCategories = 2,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(1976),
                            NumberPeople = 30,
                            PeopeRemained = 0,
                            Place = 14,
                            PostCategories = 2,
            ...
            modelBuilder.Entity("Data.Entities.MaterialStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 817, DateTimeKind.Local).AddTicks(7347),
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(121)
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3270),
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3283),
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3294),
            ...
            modelBuilder.Entity("Data.Entities.Other", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3332),
                            Name = "No Other"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Products", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2315),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2640),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2677),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2837),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2869),
                            MaterialStoreID = 1,
                            Name = "Ngói lợp",
                            SoldQuantities = 3000,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2881),
                            MaterialStoreID = 1,
                            Name = "Gạch lỗ",
                            SoldQuantities = 1500,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2891),
                            MaterialStoreID = 1,
                            Name = "Sơn chống thấm",
                            SoldQuantities = 1500,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2904),
                            MaterialStoreID = 1,
                            Name = "Cát Mịn",
                            SoldQuantities = 50,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2914),
                            MaterialStoreID = 2,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2924),
                            MaterialStoreID = 2,
                            Name = "Gạch 4 lỗ",
                            SoldQuantities = 2000,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2933),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3007),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3116),
                            MaterialStoreID = 1,
            ...
            modelBuilder.Entity("Data.Entities.ProductSize", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2193),
                            Name = "4.5L"
                        },
                        new
                        {
                            Id = 3,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2204),
                            Name = "7.5L"
                        },
                        new
                        {
                            Id = 4,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2585),
                            Name = "5M"
                        },
                        new
                        {
                            Id = 5,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2595),
                            Name = "10M"
                        },
                        new
                        {
                            Id = 7,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2970),
                            Name = "5L"
                        },
                        new
                        {
                            Id = 8,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(2981),
                            Name = "18L"
                        },
                        new
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3315),
                            Name = "No Size"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Quiz", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3398),
                        ...
                        {
                            Id = 2,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 826, DateTimeKind.Local).AddTicks(3414),
            ...
            modelBuilder.Entity("Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "db543d41-81f7-41f0-84eb-1810b5ecf566",
                            Description = "Admin",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "e2623512-92c7-4eb6-9e2b-87977b94d99b",
                            Description = "User",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "7c51e35f-89d8-47e2-a9ac-5174981bad68",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "c93bc497-6af8-4516-82e2-71d1f230497c",
                            Description = "Store",
                            Name = "Store",
            ...
            modelBuilder.Entity("Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BuilderId = 1,
                            ConcurrencyStamp = "0fc114ea-5eac-4f8b-848b-5e22ae884013",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            FirstName = "Admin",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 759, DateTimeKind.Local).AddTicks(5939),
                            LastName = "Admin",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEKCC+N4ySW+gB4c6YOM87cI7zWI2q84ahwaV7FjOL6PJfV6jtadtSB7zaCyn0wQNMg==",
                        ...
                        new
                        {
                            ...
                            Avatar = "https://i1-giaitri.vnecdn.net/2013/08/15/DK-02756-1376528749.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=mX89l0q4HQgntQ5wJesOcw",
                            BuilderId = 1,
                            ConcurrencyStamp = "94e18250-c019-40d2-adaf-c04c78acd794",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Hoai Nam",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 767, DateTimeKind.Local).AddTicks(9610),
                            LastName = "Doan Vu",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEL6UbTgbB3VZaK+XaFik9Sohr2mWVAf915iD0Tmis89luHCRCfMgFgv5bkzKxX8C2A==",
                        ...
                        new
                        {
                            ...
                            BuilderId = 2,
                            ConcurrencyStamp = "96801d66-cce9-4151-a154-cd49379b347c",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            FirstName = "Thinh",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 776, DateTimeKind.Local).AddTicks(2449),
                            LastName = "Nguyen Anh",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEHsU/3G8slBMxAQOLBkI2+HlHysMdwobhe8KcQ8kt89MlRD/gTE5MGYbIXo2ibfeew==",
                        ...
                        new
                        {
                            ...
                            Avatar = "https://scontent.fsgn5-3.fna.fbcdn.net/v/t1.6435-9/86186750_1329130013936346_7257030880831471616_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=174925&_nc_ohc=Z1GTPvzRt7wAX_WbRZ5&_nc_ht=scontent.fsgn5-3.fna&oh=00_AfAYtaD2dHE_84_-PSlDqLaeyBlH9zJ3b308pHcTWucCXw&oe=642552F2",
                            BuilderId = 3,
                            ConcurrencyStamp = "4191ca2a-4605-4f4d-9e28-828ce1b0e551",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Hieu",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 784, DateTimeKind.Local).AddTicks(6044),
                            LastName = "Nguyen Anh",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEA9etB28yrsr4ZUj5KmmlCbrgsrRJIip75iGVfWu9p9jpWOwObNgYSxYuM1cELsB3A==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "2df35d24-2f16-49b4-8d81-1d3372b2badf",
                            ContractorId = 1,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 792, DateTimeKind.Local).AddTicks(8568),
                            LastName = "NSN",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEAo/mZh1siYtfL6fGVEZGCaShCWDzSGSvxt6Zeg+r6i5W4wuTkXugHY2WvSndlflMQ==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "92d14701-d95a-4d5d-9934-6d8fa029a13d",
                            ContractorId = 2,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 801, DateTimeKind.Local).AddTicks(1959),
                            LastName = "Taseco",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEPpOZAxng5Tvk1zP5PdrSBBQVBRKqVh94WnisG/Qi/XBIY/AfmaciUXmzEILJ6lu7Q==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "8dec7ced-3b9e-4800-87cb-b09a588fe98a",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "TPHCM",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 809, DateTimeKind.Local).AddTicks(4381),
                            LastName = "Cửa Hàng Vật Liệu",
                            LockoutEnabled = false,
                            MaterialStoreID = 1,
                            PasswordHash = "AQAAAAEAACcQAAAAEB6ko9bFMV9uFlUH0iTAHmaPf++xAT347Da2WLEUzn/zAVCy+Scw9ekN+KeluLmf9A==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "ecc22526-c65a-43fd-a425-56d4154d364d",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Cần Thơ",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 3, 31, 12, 41, 9, 817, DateTimeKind.Local).AddTicks(7397),
                            LastName = "VLXD",
                            LockoutEnabled = false,
                            MaterialStoreID = 2,
                            PasswordHash = "AQAAAAEAACcQAAAAECfHD0E/JGkQjSB2GDOx6Z7PKAQmQbAhdt5/WInDChujzFTuldBH5XfYYxGFXKiT7Q==",
