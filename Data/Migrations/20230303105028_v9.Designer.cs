...
<<<<<<<< HEAD:Data/Migrations/20230303105028_v9.Designer.cs
    [Migration("20230303105028_v9")]
    partial class v9
========
    [Migration("20230303093540_v1")]
    partial class v1
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
    {
...
========
                            EndDate = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(649),
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(650),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
...
========
                            EndDate = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(714),
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(714),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            Note = "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>",
                            Status = 5,
                            StoreID = 1,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 170, DateTimeKind.Local).AddTicks(4671),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            Place = 60
                        },
                        new
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 178, DateTimeKind.Local).AddTicks(2014),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            Place = 61
                        });
                });
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 185, DateTimeKind.Local).AddTicks(8548)
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                        },
                        new
                        {
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 193, DateTimeKind.Local).AddTicks(5507)
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                        });
                });
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 208, DateTimeKind.Local).AddTicks(9557),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 208, DateTimeKind.Local).AddTicks(9610),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 208, DateTimeKind.Local).AddTicks(9646),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 208, DateTimeKind.Local).AddTicks(9685),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 20,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 208, DateTimeKind.Local).AddTicks(9712),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            NumberPeople = 30,
                            PeopeRemained = 0,
                            Place = 14,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 208, DateTimeKind.Local).AddTicks(9733),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            NumberPeople = 30,
                            PeopeRemained = 0,
                            Place = 14,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 201, DateTimeKind.Local).AddTicks(2451),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            Place = 0,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 208, DateTimeKind.Local).AddTicks(9384),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            Place = 0
                        });
                });
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(776),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(790),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(802),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 208, DateTimeKind.Local).AddTicks(9984),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            MaterialStoreID = 1,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(334),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            MaterialStoreID = 1,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(365),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            MaterialStoreID = 1,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(433),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            MaterialStoreID = 1,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(468),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            MaterialStoreID = 1,
                            Name = "Ngói lợp",
                            SoldQuantities = 3000,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(478),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            MaterialStoreID = 1,
                            Name = "Gạch lỗ",
                            SoldQuantities = 1500,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(487),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            MaterialStoreID = 1,
                            Name = "Sơn chống thấm",
                            SoldQuantities = 1500,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(496),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            MaterialStoreID = 1,
                            Name = "Cát Mịn",
                            SoldQuantities = 50,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(506),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            MaterialStoreID = 2,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(515),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            MaterialStoreID = 2,
                            Name = "Gạch 4 lỗ",
                            SoldQuantities = 2000,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(524),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            MaterialStoreID = 1,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(570),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            MaterialStoreID = 1,
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 209, DateTimeKind.Local).AddTicks(601),
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            MaterialStoreID = 1,
...
========
                            ConcurrencyStamp = "bb0d82a6-e4bf-4d6b-8e32-964ebffa7fef",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            Description = "Admin",
                            Name = "Admin",
...
========
                            ConcurrencyStamp = "c1d2a94f-5c3d-4825-b4e0-b2b1ddc13496",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            Description = "User",
                            Name = "User",
                            NormalizedName = "USER"
...
========
                            ConcurrencyStamp = "2f32af75-685c-44d2-bf68-0722e1cffaa3",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
...
========
                            ConcurrencyStamp = "1f4997d9-ac6a-4065-a12a-d7b7529b636c",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            Description = "Store",
                            Name = "Store",
...
========
                            ConcurrencyStamp = "fff0c611-4120-404c-9ea0-0aadb0ccd38d",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 162, DateTimeKind.Local).AddTicks(8275),
                            LastName = "Doan Vu",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEP4F9RaTtjppgzCMsq5cttkO0fLWTN8wmn96lw7NPeJQeSJ8TuvmXrT5GeVcoGTpJw==",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
...
========
                            ConcurrencyStamp = "13620d3b-164d-4ca0-8c1b-7341493b05c6",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 170, DateTimeKind.Local).AddTicks(4721),
                            LastName = "Nguyen Anh",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEA6kqnSmfSuJEmFOSf2/SGTbrYA3+kU/m1WyymNaUZLEbJAGMtlACR/wpds02fm8PA==",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
...
========
                            ConcurrencyStamp = "c58a4a15-0d5d-48fc-a056-75e955530f4d",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            ContractorId = 1,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 178, DateTimeKind.Local).AddTicks(2077),
                            LastName = "NSN",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEAXYdKuHcOwDWLrTkaSt8GvBmeGdXlfQjxofGbDtZbsc92HTOeklKHmTOhgacvnrMA==",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
...
========
                            ConcurrencyStamp = "da7b8a19-83c9-408c-ab50-c9f6a7ee5386",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            ContractorId = 2,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 185, DateTimeKind.Local).AddTicks(8579),
                            LastName = "Taseco",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAECVUi7/CYvyYxOIHm0FRNSUW/Pkd4YJmVkvFxmIdHhwUNBRxlm75qLfXUFEy8R+1lg==",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
...
========
                            ConcurrencyStamp = "e40d5b4c-e2a7-4462-8f60-9da578bab726",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 193, DateTimeKind.Local).AddTicks(5536),
                            LastName = "Cửa Hàng Vật Liệu",
                            LockoutEnabled = false,
                            MaterialStoreID = 1,
                            PasswordHash = "AQAAAAEAACcQAAAAENaJymoj6Tq1BSPpyfV90vy1PMv5jF0nH/t5lGqYgY70xEb94U46t8eLcvpu8u9UAw==",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
...
========
                            ConcurrencyStamp = "3c07f955-c3f5-4bd0-8e78-0c4e567baded",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
...
========
                            LastModifiedAt = new DateTime(2023, 3, 3, 16, 35, 39, 201, DateTimeKind.Local).AddTicks(2492),
                            LastName = "VLXD",
                            LockoutEnabled = false,
                            MaterialStoreID = 2,
                            PasswordHash = "AQAAAAEAACcQAAAAEPaWkVHICrUg15oKYVWRyQvd6ufBt5FR1XN4jbEStsJzOoABYU7lxhkbrZB+EU2UwA==",
>>>>>>>> origin/master:Data/Migrations/20230303093540_v1.Designer.cs
