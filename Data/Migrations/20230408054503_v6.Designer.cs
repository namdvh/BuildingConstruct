...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Entities.AppliedPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PostID = 3,
                            BuilderID = 1,
                            AppliedDate = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7667),
                            Status = 6
                        },
                        new
                        {
                            PostID = 4,
                            BuilderID = 2,
                            AppliedDate = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7686),
                            Status = 6
                        },
                        new
                        {
                            PostID = 4,
                            BuilderID = 3,
                            AppliedDate = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7696),
                            Status = 6
                        },
                        new
                        {
                            PostID = 1,
                            BuilderID = 4,
                            AppliedDate = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7707),
                            QuizId = 1,
                            Status = 6
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Bill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 4, 13, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7414),
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7421),
                            ...
                            StartDate = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7420),
                            Status = 5,
                            StoreID = 1,
                            TotalPrice = 500000m,
                            Type = 0
                        ...
                        new
                        {
                            ...
                            ContractorId = 1,
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"),
                            EndDate = new DateTime(2023, 4, 13, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7500),
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7502),
                            Note = "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>",
                            StartDate = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7501),
                            Status = 5,
                            StoreID = 1,
            ...
            modelBuilder.Entity("Data.Entities.Builder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Experience = 3,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 577, DateTimeKind.Local).AddTicks(6123),
                            Place = 60,
                        ...
                        new
                        {
                            ...
                            Experience = 3,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 579, DateTimeKind.Local).AddTicks(2839),
                            Place = 61,
                        ...
                        new
                        {
                            ...
                            Experience = 1,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 580, DateTimeKind.Local).AddTicks(8724),
                            Place = 16,
                        ...
                        new
                        {
                            Id = 4,
                            Certificate = "https://i1.rgstatic.net/publication/311457103_Certificate_of_Design_Builder_Training/links/58480cfb08aeda696825d727/largepreview.png",
                            CreateBy = new Guid("319d2a06-92cc-434d-abce-7e8a33650a0d"),
                            Experience = 4,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 582, DateTimeKind.Local).AddTicks(4691),
                            Place = 52,
                            TypeID = new Guid("ce9fa65b-d005-46b6-953e-e6462a59cfb3")
                        },
                        new
                        {
                            Id = 5,
                            Certificate = "https://i1.rgstatic.net/publication/311457103_Certificate_of_Design_Builder_Training/links/58480cfb08aeda696825d727/largepreview.png",
                            CreateBy = new Guid("8f314589-0c7c-40a4-b5bc-c73639664922"),
                            Experience = 1,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 584, DateTimeKind.Local).AddTicks(186),
                            Place = 42,
                            TypeID = new Guid("cf9fa65b-d005-46b6-953e-e6462a59cfb3")
                        },
                        new
                        {
                            Id = 6,
                            Certificate = "https://i1.rgstatic.net/publication/311457103_Certificate_of_Design_Builder_Training/links/58480cfb08aeda696825d727/largepreview.png",
                            CreateBy = new Guid("17c76dfe-7a0b-4ac9-ab8b-ba95e588a135"),
                            Experience = 2,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 585, DateTimeKind.Local).AddTicks(5818),
                            Place = 13,
                            TypeID = new Guid("cf9fa65b-d005-46b6-953e-e6462a59cfb3")
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Color", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 6,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6394),
                            Name = "Màu vàng"
                        },
                        new
                        {
                            Id = 7,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6409),
                            Name = "Màu xám"
                        },
                        new
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7604),
                            Name = "No Color"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Contractor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 587, DateTimeKind.Local).AddTicks(2348),
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 588, DateTimeKind.Local).AddTicks(8082),
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("86b8070e-00c5-45de-8db7-199cee7350d9"),
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 590, DateTimeKind.Local).AddTicks(3639),
            ...
            modelBuilder.Entity("Data.Entities.ContractorPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(5297),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(5389),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "17:30",
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(5448),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            Description = "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>",
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(5474),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 20,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(5547),
                            NumberPeople = 30,
                            PeopeRemained = 0,
                            Place = 14,
                            PostCategories = 2,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(5575),
                            NumberPeople = 30,
                            PeopeRemained = 0,
                            Place = 14,
                            PostCategories = 2,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "16:30",
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(5600),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 1,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "16:30",
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(5659),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 2,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "16:30",
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(5707),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 2,
                        ...
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndTime = "16:30",
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(5757),
                            NumberPeople = 20,
                            PeopeRemained = 0,
                            Place = 52,
                            PostCategories = 2,
            ...
            modelBuilder.Entity("Data.Entities.GroupMember", b =>
                {
                    ...
                    b.Property<int?>("BehaviourAssessment")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SkillAssessment")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Data.Entities.MaterialStore", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 591, DateTimeKind.Local).AddTicks(9120),
                            Place = 61,
                            TaxCode = "8156184163",
                        ...
                        new
                        {
                            ...
                            Experience = "Hiện đang là đại lý cấp 1 phân phối các sản phẩm chất lượng, có thương hiệu nổi tiếng, giá thành phù hợp với giá niêm yết của nhà máy. Công ty còn cung cấp và phân phối nhiều loại cát bê tông và cát xây dựng được sàng và rửa tại dây chuyền sản xuất. Ngoài ra còn phân phối nhiều loại vật liệu xây dựng khác như xi măng, gạch, sắt thép đảm bảo chất lượng cao để sử dụng cho các công trình xây dựng.",
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(4931),
                            Place = 61,
                            TaxCode = "8156284563"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7559),
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7574),
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"),
                            IsRead = false,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7588),
            ...
            modelBuilder.Entity("Data.Entities.Other", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7643),
                            Name = "No Other"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.PostInvite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PostInvite", (string)null);
                });
            ...
            modelBuilder.Entity("Data.Entities.Products", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6195),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6492),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6538),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6633),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6674),
                            MaterialStoreID = 1,
                            Name = "Ngói lợp",
                            SoldQuantities = 3000,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6826),
                            MaterialStoreID = 1,
                            Name = "Gạch lỗ",
                            SoldQuantities = 1500,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6850),
                            MaterialStoreID = 1,
                            Name = "Sơn chống thấm",
                            SoldQuantities = 1500,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6867),
                            MaterialStoreID = 1,
                            Name = "Cát Mịn",
                            SoldQuantities = 50,
                            Status = true,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6883),
                            MaterialStoreID = 2,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6974),
                            MaterialStoreID = 2,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7062),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7232),
                            MaterialStoreID = 1,
                        ...
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7289),
                            MaterialStoreID = 1,
            ...
            modelBuilder.Entity("Data.Entities.ProductSize", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6046),
                            Name = "4.5L"
                        },
                        new
                        {
                            Id = 3,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6061),
                            Name = "7.5L"
                        },
                        new
                        {
                            Id = 4,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6421),
                            Name = "5M"
                        },
                        new
                        {
                            Id = 5,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6433),
                            Name = "10M"
                        },
                        new
                        {
                            Id = 14,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6942),
                            Name = "Giường 1,8m"
                        },
                        new
                        {
                            Id = 15,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(6959),
                            Name = "Giường 2m"
                        },
                        new
                        {
                            Id = 10,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7033),
                            Name = "6 bóng"
                        },
                        new
                        {
                            Id = 11,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7048),
                            Name = "8 bóng"
                        },
                        new
                        {
                            Id = 7,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7122),
                            Name = "5L"
                        },
                        new
                        {
                            Id = 8,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7139),
                            Name = "18L"
                        },
                        new
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7618),
                            Name = "No Size"
                        });
                });
            ...
            modelBuilder.Entity("Data.Entities.Quiz", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(7790),
                        ...
                        {
                            Id = 2,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 593, DateTimeKind.Local).AddTicks(8010),
            ...
            modelBuilder.Entity("Data.Entities.Report", b =>
                {
                    ...
                    b.Property<string>("ReportProblem")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "b932d9fa-c81d-4d36-b4b0-df332296c5bf",
                            Description = "Admin",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b11010e1-a138-4c89-b6c6-6e10c3eb8f0d",
                            Description = "User",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "8b6f0e12-2174-4a7a-a33a-3519d930ac19",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "5bd0e59a-f9dd-406d-962f-44f1fc44f402",
                            Description = "Store",
                            Name = "Store",
            ...
            modelBuilder.Entity("Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d7285fb7-835b-4680-a18c-673bd71f63e9"),
                            AccessFailedCount = 0,
                            ...
                            BuilderId = 1,
                            ConcurrencyStamp = "490ab90e-96a6-40f5-a995-4d65be75cbaf",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            FirstName = "Admin",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 574, DateTimeKind.Local).AddTicks(2605),
                            LastName = "Admin",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEMrMQ3oHmHLDEBvCMlEAYxrHqI5Q3JWNVl/mvJpUd+pB3lBjGrLBPV3XhU74caSa8g==",
                        ...
                        new
                        {
                            ...
                            Avatar = "https://i1-giaitri.vnecdn.net/2013/08/15/DK-02756-1376528749.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=mX89l0q4HQgntQ5wJesOcw",
                            BuilderId = 1,
                            ConcurrencyStamp = "d6e044e8-b4e6-4a80-a3a5-0ecbf5613e24",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Hoai Nam",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 575, DateTimeKind.Local).AddTicks(8731),
                            LastName = "Doan Vu",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEIaaL1ty4un69nrDa8zRAWkadqOGwaktkr8kgN8MJbLxsVEXxoh0/zNXtIXpXzTLGg==",
                        ...
                        new
                        {
                            ...
                            BuilderId = 2,
                            ConcurrencyStamp = "455c1e57-9a05-43ed-b737-dc096cdb6d3a",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ...
                            FirstName = "Thinh",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 577, DateTimeKind.Local).AddTicks(6236),
                            LastName = "Nguyen Anh",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEAeaYr0JFeHrxjsF8rjSq7WGnUDR2zBsf4pFAv27YjjwtRPwSnS/+pGkDJfpd2WaYA==",
                        ...
                        new
                        {
                            Id = new Guid("d91f9ece-25a7-4dc6-adde-186b12c04d56"),
                            AccessFailedCount = 0,
                            Address = "56 Nguyễn Duy Trinh, Huyện Chợ Đồn, Bắc Kạn",
                            Avatar = "https://scontent.fsgn5-3.fna.fbcdn.net/v/t1.6435-9/86186750_1329130013936346_7257030880831471616_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=174925&_nc_ohc=Z1GTPvzRt7wAX_WbRZ5&_nc_ht=scontent.fsgn5-3.fna&oh=00_AfAYtaD2dHE_84_-PSlDqLaeyBlH9zJ3b308pHcTWucCXw&oe=642552F2",
                            BuilderId = 3,
                            ConcurrencyStamp = "5d11e583-d964-4b58-a9b0-ddf7ea9d56b3",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Hieu",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 579, DateTimeKind.Local).AddTicks(2934),
                            LastName = "Nguyen Anh",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAELA8ZqjKH5Iqgf4z+qok+QH9z/0FI4rbkL4Co2aWnfhLwe8bQbgG1AFH9i4ntVibYg==",
                        ...
                        new
                        {
                            Id = new Guid("319d2a06-92cc-434d-abce-7e8a33650a0d"),
                            AccessFailedCount = 0,
                            Address = "56 Nguyễn Duy Trinh, Huyện Chợ Đồn, Bắc Kạn",
                            ...
                            BuilderId = 4,
                            ConcurrencyStamp = "17a52a9b-8533-4ca0-b1bc-dc9f182ef264",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Minh",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 580, DateTimeKind.Local).AddTicks(8808),
                            LastName = "Nguyen Trần",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEFzP2gGtGR+McPY/94sYnLWLeyVNyxKC0ovwy1MYKEUB8pfsBiJ3I1pjYaYQdqBqqg==",
                        ...
                        new
                        {
                            Id = new Guid("8f314589-0c7c-40a4-b5bc-c73639664922"),
                            AccessFailedCount = 0,
                            ...
                            BuilderId = 5,
                            ConcurrencyStamp = "cf3714b4-927d-4cb8-ab4e-cb172857e9cb",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Trúc",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 582, DateTimeKind.Local).AddTicks(4747),
                            LastName = "Phạm Thanh",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEP7+c4+aGJvQAwY86uAMo/5+GUGB/8OpULFWgPszjBt718oYJmExeFKd1sM5vtF+cQ==",
                        ...
                        new
                        {
                            Id = new Guid("17c76dfe-7a0b-4ac9-ab8b-ba95e588a135"),
                            AccessFailedCount = 0,
                            Address = "135 Nguyễn Hiếu, Huyện Chợ Đồn, Bắc Kạn",
                            Avatar = "https://demoda.vn/wp-content/uploads/2022/03/mau-anh-the-ong-chu-so-mi-trang.jpg",
                            BuilderId = 6,
                            ConcurrencyStamp = "07ba26cf-c101-4a08-b186-14b9aa7e0707",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "namhoaidoan15@gmail.com",
                            EmailConfirmed = false,
                            FirstName = "Dương",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 584, DateTimeKind.Local).AddTicks(258),
                            LastName = "Thanh Vàng",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEI5CoTcV80bwW5Ub0JDlT62bDa0PrzCjXbW35uoY44JPr5aoyb1GgOtKjX0QnH/5VQ==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "2f677a51-7e42-4e10-aadb-e537174302f0",
                            ContractorId = 1,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 585, DateTimeKind.Local).AddTicks(5923),
                            LastName = "NSN",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAELUuSb3OPZcS4yHc1UjiV2cFOyCpZwUsIdDdUqH0D26nFE835c/bYER2PeKM+hXg5w==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "8583d951-95ca-424e-b70e-bfa91556adda",
                            ContractorId = 2,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 587, DateTimeKind.Local).AddTicks(2405),
                            LastName = "Taseco",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEFiO0FZcirIxLmAqzodOV3IikZNWpGTERDMcDM5xNlGuh78i8A2JLOXqlSN8uBE9oQ==",
                        ...
                        new
                        {
                            Id = new Guid("86b8070e-00c5-45de-8db7-199cee7350d9"),
                            AccessFailedCount = 0,
                            Address = "56 Nguyễn Duy Trinh, Huyện Mỏ Cày Nam, Bến Tre",
                            Avatar = "https://diaocthinhvuong.vn/wp-content/uploads/2021/05/1logo-newtecons.jpg",
                            ConcurrencyStamp = "44547775-0805-4d31-8490-489ba23f4b24",
                            ContractorId = 3,
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 588, DateTimeKind.Local).AddTicks(8097),
                            LastName = "Ánh Nhiên Xanh",
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAEAACcQAAAAEP/evUg4au6D4mflt62P8jO/Owku3pxg3Fotwx/5HWg63UIcI+HO2o29BzMqdvkxjw==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "5dabed33-06bb-4ca9-beba-67477c25dd52",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "TPHCM",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 590, DateTimeKind.Local).AddTicks(3653),
                            LastName = "Cửa Hàng Vật Liệu",
                            LockoutEnabled = false,
                            MaterialStoreID = 1,
                            PasswordHash = "AQAAAAEAACcQAAAAEBzNTwDPWlFX6KrDWuCBpLTvvStnyx5SH0lft6n5Pc/MehZrRUyufrBxi+5J1L6QqA==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "a16f7ab0-fd6b-45a1-a62b-b35a6c086e54",
                            CreateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            DOB = new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Cần Thơ",
                            Gender = 0,
                            LastModifiedAt = new DateTime(2023, 4, 8, 12, 45, 2, 591, DateTimeKind.Local).AddTicks(9144),
                            LastName = "VLXD",
                            LockoutEnabled = false,
                            MaterialStoreID = 2,
                            PasswordHash = "AQAAAAEAACcQAAAAEGHnLeF+B4VPd51X0/wFAcSVo+W3txYyW7MCSlLQvArkG2rbuPXH7CnUTIkomYL/hQ==",
            ...
            modelBuilder.Entity("Data.Entities.UserAnswer", b =>
                {
                    b.Property<int>("BuilderId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("d7285fb7-835b-4680-a18c-673bd71f63e9"),
                        ...
                        new
                        {
                            UserId = new Guid("d91f9ece-25a7-4dc6-adde-186b12c04d56"),
                            RoleId = new Guid("dc48ba58-ddcb-41de-96fe-e41327e5f313")
                        },
                        new
                        {
                            UserId = new Guid("319d2a06-92cc-434d-abce-7e8a33650a0d"),
                            RoleId = new Guid("dc48ba58-ddcb-41de-96fe-e41327e5f313")
                        },
                        new
                        {
                            UserId = new Guid("8f314589-0c7c-40a4-b5bc-c73639664922"),
                            RoleId = new Guid("dc48ba58-ddcb-41de-96fe-e41327e5f313")
                        },
                        new
                        {
                            UserId = new Guid("17c76dfe-7a0b-4ac9-ab8b-ba95e588a135"),
                            RoleId = new Guid("dc48ba58-ddcb-41de-96fe-e41327e5f313")
                        },
                        new
                        {
                        ...
                        new
                        {
                            UserId = new Guid("86b8070e-00c5-45de-8db7-199cee7350d9"),
                            RoleId = new Guid("20efd516-f16c-41b3-b11d-bc908cd2056b")
                        },
                        new
                        {
