    ...
    public partial class v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4505), "No Color" },
                    { 6, null, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(3783), "Màu vàng" },
                    { 7, null, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(3797), "Màu xám" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"), null, new DateTime(2023, 3, 29, 12, 7, 30, 997, DateTimeKind.Local).AddTicks(7700), null },
                    { 2, null, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d6"), null, new DateTime(2023, 3, 29, 12, 7, 31, 6, DateTimeKind.Local).AddTicks(7330), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new Guid("b57b172a-a044-11ed-a8fc-0242ac120002"), "Với mục tiêu cung cấp nhiều gói sản phẩm phong phú về mẫu mã và các tính năng linh hoạt cho nhiều loại hình website như giới thiệu công ty, bán hàng, trang tin tức, thương mại điện tử… cùng với nhiều giao diện phong phú đa dạng độc đáo đã được VNS lọc chọn và đúc kết nhằm giới thiệu tới khách hàng với mong muốn có một website nhanh, đẹp, hiệu quả và giá cả hợp lý.", null, null, new DateTime(2023, 3, 29, 12, 7, 31, 15, DateTimeKind.Local).AddTicks(5371), 0, null, "https://vinasoftware.com.vn/" },
                    { 2, new Guid("be21b564-a044-11ed-a8fc-0242ac120002"), null, null, null, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(2530), 0, null, null }
                });

            migrationBuilder.InsertData(
                table: "Other",
                columns: new[] { "Id", "Image", "LastModifiedAt", "Name" },
                values: new object[] { 1, null, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4540), "No Other" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("20efd516-f16c-41b3-b11d-bc908cd2056b"), "b67d6992-57d2-4ac9-b3d0-0cf7969cf82c", "Contractor", "Contractor", "CONTRACTOR" },
                    { new Guid("52ec6e78-6732-43bf-adab-9cfa2e5da268"), "1ec50966-5758-4064-943f-12e0c0cc5cf2", "Admin", "Admin", "ADMIN" },
                    { new Guid("a4fbc29e-9749-4ea0-bcaa-67fc9f104bd1"), "64c60bfe-afb1-412c-b4af-94a8a6045352", "Store", "Store", "STORE" },
                    { new Guid("dc48ba58-ddcb-41de-96fe-e41327e5f313"), "0a703184-5953-4629-b111-990e1be18b6e", "User", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4518), "No Size" },
                    { 2, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(3469), "4.5L" },
                    { 3, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(3482), "7.5L" },
                    { 4, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(3808), "5M" },
                    { 5, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(3820), "10M" },
                    { 7, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4189), "5L" },
                    { 8, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4200), "18L" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("d7285fb7-835b-4680-a18c-673bd71f63e9"), 0, "18, Phuoc Thien, Nhon Trach, Dong Nai", "https://i1-giaitri.vnecdn.net/2013/08/15/DK-02756-1376528749.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=mX89l0q4HQgntQ5wJesOcw", null, "9c0f047a-b22d-4cb7-821d-4b599b445697", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin15@gmail.com", false, "Admin", 0, null, new DateTime(2023, 3, 29, 12, 7, 30, 953, DateTimeKind.Local).AddTicks(4166), "Admin", false, null, null, null, null, null, "AQAAAAEAACcQAAAAEFObt8AxGEcu5BexXUwix/XqywthLF+oCKtAva3ppeDBp9HzXFk55LBmO3wQ9Ybrhg==", "0909090909", false, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "admin15@gmail.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"), new DateTime(2023, 4, 3, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4339), new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4347), "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>", null, null, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4346), 5, 1, 500000m, 0 },
                    { 2, 1, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"), new DateTime(2023, 4, 3, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4410), new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4413), "<div>I. THÔNG TIN CHUNG</div><div>1. Quy trình công việc liên quan: Quy trình quản lí dự án (mảng bản vẽ, báo giá, tiến độ)</div><div>2. Cấp trực tiếp quản lý: Giám đốc dự án</div><div>3. Loại hợp đồng: Hợp đồng xác định có thời hạn/không thời hạn</div><div><br></div><div>II. MỤC ĐÍCH CÔNG VIỆC</div><div>Nắm bản vẽ của dự án từ lúc đấu thầu, hiểu rõ các spect của dự án để báo giá. Có khả năng bốc khối lượng để đối ứng với cá báo giá gấp, các hạng mục phát sinh. Khi dự án trúng thấu, có khả năng điều phối dự án ở vai trò quản lí thiết kế, quản lí tiến độ, hoặc quản lí chất lượng (đối với dự án quy mô nhỏ)</div><div><br></div><div>III. TRÁCH NHIỆM VÀ NHIỆM VỤ</div><div>1. Làm báo giá dự án Nhật và hỗ trợ giám đốc dự án đi đấu thầu</div><div>• Nắm rõ bản vẽ của dự án từ lúc đấu thầu</div><div>• Hiểu rõ các vật tư spect của ngành kết cấu thép để báo giá</div><div>• Có khả năng bốc khối lượng cho các dự án gấp</div><div>• Có khả năng lên các bản vẽ đề xuất bằng CAD</div><div>• Cùng với GDDA đi đấu thầu các dự án</div><div>• Tiếp khách, đối ứng khách khi có audit, khách về việt nam</div><div><br></div><div>2. Quản lí dự án trúng thầu mảng quản lí bản vẽ thiết kế, quản lí tiến độ</div><div>• Nắm rõ các thay đổi thiết kế, chỉ thị bản vẽ của khách để triển khai cho shop</div><div>• Sử dụng thành thạo Tekla hoặc phần mềm real 4 để xuất các giấy tờ phục vụ cho quản lí dự án</div><div>• Lên được kế hoạch sản xuất và quản lí sản xuất, xuất hàng</div><div><br></div><div>3. Đối ứng khách hàng</div><div>• Báo cáo tiến độ sản xuất, bản vẽ</div><div>• Tham gia chủ đạo trong các cuộc họp tiến độ với nhà máy</div><div><br></div><div>4 . Nghiên cứu &amp; Phát triển</div><div>• Tham gia nghiên cứu và phát triển giải pháp công nghệ sản xuất</div><div><br></div><div>5. Tổng kết và đúc kết kinh nghiệm quản lí dự án</div><div>• Tổng kết thường xuyên các vướng mắt trong tiến độ, bản vẽ . Các lỗi hay mắc phải, hướng xử lí</div><div>• Đối với NCR đóng vai trò chỉ huy xử lí (liên quan tiến độ, chất lượng)</div><div><br></div><div>6. Cost control</div><div>• Phối hợp với giám đốc dự án trong công tác giám sát ngân sách thực hiện</div><div><br></div><div>7. Nhiệm vụ khác</div><div>• Các nhiệm vụ khác được phân công</div>", null, null, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4412), 5, 1, 60000000m, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, null, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), null, null, null, new DateTime(2023, 3, 29, 12, 7, 30, 971, DateTimeKind.Local).AddTicks(525), 60, new Guid("4ace8fcb-95eb-48c0-9deb-240e8b4e10e0") },
                    { 2, null, null, new Guid("d39ae0a6-9b2d-4421-be4a-cc294cec054f"), null, null, null, new DateTime(2023, 3, 29, 12, 7, 30, 980, DateTimeKind.Local).AddTicks(371), 61, new Guid("bd880489-5c76-4854-93ab-66e3a541bf24") },
                    { 3, null, null, new Guid("d91f9ece-25a7-4dc6-adde-186b12c04d56"), null, null, null, new DateTime(2023, 3, 29, 12, 7, 30, 988, DateTimeKind.Local).AddTicks(9431), 61, new Guid("ce9fa65b-d005-46b6-953e-e6462a59cfb3") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Pháp", new Guid("00000000-0000-0000-0000-000000000000"), null, "Ngói lợp kiểu Pháp cổ điển", "https://sbo.vn/wp-content/uploads/2021/06/tam-lop-sinh-thai-onduline.jpg", new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4075), 1, "Ngói lợp", 3000, "ton", 300000, 700m },
                    { 2, "Việt Nam", new Guid("00000000-0000-0000-0000-000000000000"), null, "Gạch 2 lỗ cao cấp đến từ thương hiệu nổi tiếng ", "http://www.phudien.vn/upload/Product%20400x200/G%E1%BA%A1ch%20tuynel%20-%20g%E1%BA%A1ch%206%20l%E1%BB%97%20lo%E1%BA%A1i%20nh%E1%BB%8F.png", new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4087), 1, "Gạch lỗ", 1500, "ton", 300000, 40000m },
                    { 3, "Mỹ", new Guid("00000000-0000-0000-0000-000000000000"), null, "Sơn chống thấm Nippon", "https://nipponpaint.com.vn/sites/default/files/inline-images/son-chong-tham-la-gi-1.jpg", new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4099), 1, "Sơn chống thấm", 1500, "ton", 2000, 1000000m },
                    { 4, "Việt Nam", new Guid("00000000-0000-0000-0000-000000000000"), null, "Cát mịn dành cho xây dựng đặc biệt dành cho ngôi nhà yêu dấu của bạn", "https://sbshouse.vn/wp-content/uploads/2020/09/cat-xay-dung.jpg", new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4110), 1, "Cát Mịn", 50, "ton", 200000, 50000m },
                    { 5, "Việt Nam", new Guid("00000000-0000-0000-0000-000000000000"), null, "Xi măng Hà Tiên", "http://ximang.vn/Upload/48/Nam_2022/Thang_5/Ngay_31/ximang_vicemhatien1.jpg", new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4123), 2, "Xi măng Hà Tiên", 300, "ton", 5000, 80000m },
                    { 6, "Việt Nam", new Guid("00000000-0000-0000-0000-000000000000"), null, "Gạch 4 lỗ", "https://imgcdn9h.store123doc.com/article/2019_1_w4/508-gach-4-lo-nua-duoc-su-dung-cung-voi-gach-4-lo-nguyen-de-xay-nha.jpeg", new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4135), 2, "Gạch 4 lỗ", 2000, "ton", 500000, 700000m },
                    ...
                    { 38, "NIRO GRANITE", new Guid("00000000-0000-0000-0000-000000000000"), null, "GHR Gạch Granite Hardrock Mờ/Bán bóng ", "https://admin.mingstores.com/core/public/themes/mingstores/products/6TauBDiJiwnvQaJTuCl9D0SYHFayTRHk.jpg", new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4038), 1, "GHR Gạch Granite Hardrock Mờ/Bán bóng", 1500, "Viên", 200, 360000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), false, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4464), "Someone has saved your post", 1, "New Notification", 0, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7") },
                    { 2, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), false, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4480), "Someone has applied your post", 1, "New Notification", 1, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7") },
                    { 3, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), false, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4492), "Create commitment successfully", 1, "New Notification", 2, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4609), "Bài test thợ xây ", 1, new Guid("4ace8fcb-95eb-48c0-9deb-240e8b4e10e0") },
                    { 2, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4626), "Bài test thợ sơn ", 1, new Guid("ce9fa65b-d005-46b6-953e-e6462a59cfb3") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d39ae0a6-9b2d-4421-be4a-cc294cec054f"), 0, "18, Phuoc Thien, Nhon Trach, Dong Nai", "https://scontent.fsgn5-3.fna.fbcdn.net/v/t1.6435-9/86186750_1329130013936346_7257030880831471616_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=174925&_nc_ohc=Z1GTPvzRt7wAX_WbRZ5&_nc_ht=scontent.fsgn5-3.fna&oh=00_AfAYtaD2dHE_84_-PSlDqLaeyBlH9zJ3b308pHcTWucCXw&oe=642552F2", 2, "6ae86569-bf05-4e59-b88e-b7c010678f7e", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "namhoaidoan1@gmail.com", false, "Thinh", 0, null, new DateTime(2023, 3, 29, 12, 7, 30, 971, DateTimeKind.Local).AddTicks(578), "Nguyen Anh", false, null, null, null, null, null, "AQAAAAEAACcQAAAAEPpE16UhdH1uncfKjDveQmblu9F8NLdJO80TLIBmx7nqEqyihyIJdvznzB1Ea7Ci4A==", "0937341639", false, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "namhoaidoan1@gmail.com" },
                    { new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), 0, "18, Phuoc Thien, Nhon Trach, Dong Nai", "https://i1-giaitri.vnecdn.net/2013/08/15/DK-02756-1376528749.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=mX89l0q4HQgntQ5wJesOcw", 1, "3c180dbd-4c2e-4753-9b74-0e106874a9ce", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "namhoaidoan15@gmail.com", false, "Hoai Nam", 0, null, new DateTime(2023, 3, 29, 12, 7, 30, 962, DateTimeKind.Local).AddTicks(2953), "Doan Vu", false, null, null, null, null, null, "AQAAAAEAACcQAAAAELZCsevL94MnX0r/AbNz2YtIlYufTxi2xj6mnrgD7OgTgkF0oz8Axl68pbWJb1ADpw==", "0879411575", false, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "namhoaidoan15@gmail.com" },
                    { new Guid("d91f9ece-25a7-4dc6-adde-186b12c04d56"), 0, "18, Phuoc Thien, Nhon Trach, Dong Nai", "https://scontent.fsgn5-3.fna.fbcdn.net/v/t1.6435-9/86186750_1329130013936346_7257030880831471616_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=174925&_nc_ohc=Z1GTPvzRt7wAX_WbRZ5&_nc_ht=scontent.fsgn5-3.fna&oh=00_AfAYtaD2dHE_84_-PSlDqLaeyBlH9zJ3b308pHcTWucCXw&oe=642552F2", 3, "4ae24b29-977a-4eb1-a544-dbee86556aa7", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "namhoaidoan12@gmail.com", false, "Hieu", 0, null, new DateTime(2023, 3, 29, 12, 7, 30, 980, DateTimeKind.Local).AddTicks(474), "Nguyen Anh", false, null, null, null, null, null, "AQAAAAEAACcQAAAAEKgXloREZ5idhiVcnt3KsVHdOjfoRtBp+OkRAylLsG0ULDi+g6Hlvk2eGf1uupzY8w==", "0101010101", false, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "namhoaidoan12@gmail.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4561), null, 1, 6, null },
                    { 2, 1, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4573), null, 1, 6, null },
                    { 3, 1, new DateTime(2023, 3, 29, 12, 7, 31, 25, DateTimeKind.Local).AddTicks(4584), null, 1, 6, null }
                });
