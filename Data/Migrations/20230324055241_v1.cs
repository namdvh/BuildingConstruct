        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Builders_BuilderId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_MaterialStores_MaterialStoreID",
                        column: x => x.MaterialStoreID,
                        principalTable: "MaterialStores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IdentitficationCards_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("20efd516-f16c-41b3-b11d-bc908cd2056b"), "89a05965-c740-4a00-a344-f41a3589c6ce", "Contractor", "Contractor", "CONTRACTOR" },
                    { new Guid("52ec6e78-6732-43bf-adab-9cfa2e5da268"), "0f0155e5-ba51-43ca-8e5b-c5990758df71", "Admin", "Admin", "ADMIN" },
                    { new Guid("a4fbc29e-9749-4ea0-bcaa-67fc9f104bd1"), "0b95d7a3-0fe7-4661-beb1-4e0c0a8ad9bf", "Store", "Store", "STORE" },
                    { new Guid("dc48ba58-ddcb-41de-96fe-e41327e5f313"), "b0ddd31c-1591-4461-aeb8-11f02c4dd258", "User", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("d7285fb7-835b-4680-a18c-673bd71f63e9"), 0, "18, Phuoc Thien, Nhon Trach, Dong Nai", "https://i1-giaitri.vnecdn.net/2013/08/15/DK-02756-1376528749.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=mX89l0q4HQgntQ5wJesOcw", null, "7a9f6fd1-ce3f-4502-a8b7-326f03eac978", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin15@gmail.com", false, "Admin", 0, null, new DateTime(2023, 3, 24, 12, 52, 40, 755, DateTimeKind.Local).AddTicks(5138), "Admin", false, null, null, null, null, null, "AQAAAAEAACcQAAAAEGc4P4lDa6+ECKsWoX8pjJ9HQL9qcNhM3vPzHEqbaSuAEUV0TJGeoUjto+XOpGRMmg==", "0909090909", false, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "admin15@gmail.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(4142), "No Color" },
                    { 6, null, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(2242), "Màu vàng" },
                    { 7, null, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(2255), "Màu xám" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7"), null, new DateTime(2023, 3, 24, 12, 52, 40, 792, DateTimeKind.Local).AddTicks(7497), null },
                    { 2, null, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d6"), null, new DateTime(2023, 3, 24, 12, 52, 40, 800, DateTimeKind.Local).AddTicks(2686), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new Guid("b57b172a-a044-11ed-a8fc-0242ac120002"), "Với mục tiêu cung cấp nhiều gói sản phẩm phong phú về mẫu mã và các tính năng linh hoạt cho nhiều loại hình website như giới thiệu công ty, bán hàng, trang tin tức, thương mại điện tử… cùng với nhiều giao diện phong phú đa dạng độc đáo đã được VNS lọc chọn và đúc kết nhằm giới thiệu tới khách hàng với mong muốn có một website nhanh, đẹp, hiệu quả và giá cả hợp lý.", null, null, new DateTime(2023, 3, 24, 12, 52, 40, 807, DateTimeKind.Local).AddTicks(6674), 0, null, "https://vinasoftware.com.vn/" },
                    { 2, new Guid("be21b564-a044-11ed-a8fc-0242ac120002"), null, null, null, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(1267), 0, null, null }
                });

            migrationBuilder.InsertData(
                table: "Other",
                columns: new[] { "Id", "Image", "LastModifiedAt", "Name" },
                values: new object[] { 1, null, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(4188), "No Other" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(4162), "No Size" },
                    { 2, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(1989), "4.5L" },
                    { 3, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(2002), "7.5L" },
                    { 4, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(2265), "5M" },
                    { 5, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(2452), "10M" },
                    { 7, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(3305), "5L" },
                    { 8, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(3371), "18L" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("52ec6e78-6732-43bf-adab-9cfa2e5da268"), new Guid("d7285fb7-835b-4680-a18c-673bd71f63e9") });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, null, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), null, null, null, new DateTime(2023, 3, 24, 12, 52, 40, 770, DateTimeKind.Local).AddTicks(4326), 60, new Guid("4ace8fcb-95eb-48c0-9deb-240e8b4e10e0") },
                    { 2, null, null, new Guid("d39ae0a6-9b2d-4421-be4a-cc294cec054f"), null, null, null, new DateTime(2023, 3, 24, 12, 52, 40, 777, DateTimeKind.Local).AddTicks(8629), 61, new Guid("bd880489-5c76-4854-93ab-66e3a541bf24") },
                    { 3, null, null, new Guid("d91f9ece-25a7-4dc6-adde-186b12c04d56"), null, null, null, new DateTime(2023, 3, 24, 12, 52, 40, 785, DateTimeKind.Local).AddTicks(3374), 61, new Guid("ce9fa65b-d005-46b6-953e-e6462a59cfb3") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Pháp", new Guid("00000000-0000-0000-0000-000000000000"), null, "Ngói lợp kiểu Pháp cổ điển", "https://sbo.vn/wp-content/uploads/2021/06/tam-lop-sinh-thai-onduline.jpg", new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(2652), 1, "Ngói lợp", 3000, "ton", 300000, 700m },
                    { 2, "Việt Nam", new Guid("00000000-0000-0000-0000-000000000000"), null, "Gạch 2 lỗ cao cấp đến từ thương hiệu nổi tiếng ", "http://www.phudien.vn/upload/Product%20400x200/G%E1%BA%A1ch%20tuynel%20-%20g%E1%BA%A1ch%206%20l%E1%BB%97%20lo%E1%BA%A1i%20nh%E1%BB%8F.png", new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(2662), 1, "Gạch lỗ", 1500, "ton", 300000, 40000m },
                    { 3, "Mỹ", new Guid("00000000-0000-0000-0000-000000000000"), null, "Sơn chống thấm Nippon", "https://nipponpaint.com.vn/sites/default/files/inline-images/son-chong-tham-la-gi-1.jpg", new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(2673), 1, "Sơn chống thấm", 1500, "ton", 2000, 1000000m },
                    { 4, "Việt Nam", new Guid("00000000-0000-0000-0000-000000000000"), null, "Cát mịn dành cho xây dựng đặc biệt dành cho ngôi nhà yêu dấu của bạn", "https://sbshouse.vn/wp-content/uploads/2020/09/cat-xay-dung.jpg", new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(2682), 1, "Cát Mịn", 50, "ton", 200000, 50000m },
                    { 5, "Việt Nam", new Guid("00000000-0000-0000-0000-000000000000"), null, "Xi măng Hà Tiên", "http://ximang.vn/Upload/48/Nam_2022/Thang_5/Ngay_31/ximang_vicemhatien1.jpg", new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(3020), 2, "Xi măng Hà Tiên", 300, "ton", 5000, 80000m },
                    { 6, "Việt Nam", new Guid("00000000-0000-0000-0000-000000000000"), null, "Gạch 4 lỗ", "https://imgcdn9h.store123doc.com/article/2019_1_w4/508-gach-4-lo-nua-duoc-su-dung-cung-voi-gach-4-lo-nguyen-de-xay-nha.jpeg", new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(3174), 2, "Gạch 4 lỗ", 2000, "ton", 500000, 700000m },
                    ...
                    { 38, "NIRO GRANITE", new Guid("00000000-0000-0000-0000-000000000000"), null, "GHR Gạch Granite Hardrock Mờ/Bán bóng ", "https://admin.mingstores.com/core/public/themes/mingstores/products/6TauBDiJiwnvQaJTuCl9D0SYHFayTRHk.jpg", new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(2620), 1, "GHR Gạch Granite Hardrock Mờ/Bán bóng", 1500, "Viên", 200, 360000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d39ae0a6-9b2d-4421-be4a-cc294cec054f"), 0, "18, Phuoc Thien, Nhon Trach, Dong Nai", "https://scontent.fsgn5-3.fna.fbcdn.net/v/t1.6435-9/86186750_1329130013936346_7257030880831471616_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=174925&_nc_ohc=Z1GTPvzRt7wAX_WbRZ5&_nc_ht=scontent.fsgn5-3.fna&oh=00_AfAYtaD2dHE_84_-PSlDqLaeyBlH9zJ3b308pHcTWucCXw&oe=642552F2", 2, "3e01d825-dfa3-4554-932d-c7aff31290a1", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "namhoaidoan1@gmail.com", false, "Thinh", 0, null, new DateTime(2023, 3, 24, 12, 52, 40, 770, DateTimeKind.Local).AddTicks(4405), "Nguyen Anh", false, null, null, null, null, null, "AQAAAAEAACcQAAAAEGJJ+Fpu9FxdyS72nFDIHRagwQV3Dw2xn/B0RvVAT+IpeoJwjVTEt8wIGMiAsdrHPg==", "0937341639", false, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "namhoaidoan1@gmail.com" },
                    { new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), 0, "18, Phuoc Thien, Nhon Trach, Dong Nai", "https://i1-giaitri.vnecdn.net/2013/08/15/DK-02756-1376528749.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=mX89l0q4HQgntQ5wJesOcw", 1, "6ed5ccc5-447e-4fca-a5ae-8a00e323f605", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "namhoaidoan15@gmail.com", false, "Hoai Nam", 0, null, new DateTime(2023, 3, 24, 12, 52, 40, 762, DateTimeKind.Local).AddTicks(9387), "Doan Vu", false, null, null, null, null, null, "AQAAAAEAACcQAAAAEIMZAQl3AhCDlXYeWZ0GX25FoFk+hJFqnWK1cdYP9mSrbPH5GJyYipbZkBUe623crQ==", "0879411575", false, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "namhoaidoan15@gmail.com" },
                    { new Guid("d91f9ece-25a7-4dc6-adde-186b12c04d56"), 0, "18, Phuoc Thien, Nhon Trach, Dong Nai", "https://scontent.fsgn5-3.fna.fbcdn.net/v/t1.6435-9/86186750_1329130013936346_7257030880831471616_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=174925&_nc_ohc=Z1GTPvzRt7wAX_WbRZ5&_nc_ht=scontent.fsgn5-3.fna&oh=00_AfAYtaD2dHE_84_-PSlDqLaeyBlH9zJ3b308pHcTWucCXw&oe=642552F2", 3, "ab6dd95a-86fa-4eec-90b3-87ce84ea1935", null, new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(2001, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "namhoaidoan12@gmail.com", false, "Hieu", 0, null, new DateTime(2023, 3, 24, 12, 52, 40, 777, DateTimeKind.Local).AddTicks(8676), "Nguyen Anh", false, null, null, null, null, null, "AQAAAAEAACcQAAAAEKs8NkIsOfos8MAJJ2+6UwXuzz/+/57voSYAOucUlEq2p8NRz3CL+X5bUDpIzPo1jA==", "0101010101", false, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 0, "xxx", false, "namhoaidoan12@gmail.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), false, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(4080), "Someone has saved your post", 1, "New Notification", 0, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7") },
                    { 2, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), false, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(4105), "Someone has applied your post", 1, "New Notification", 1, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7") },
                    { 3, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d9"), false, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(4120), "Create commitment successfully", 1, "New Notification", 2, new Guid("d7285fb7-835b-4680-a18c-673bd71f63d7") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(4279), "Bài test thợ xây ", 1, new Guid("4ace8fcb-95eb-48c0-9deb-240e8b4e10e0") },
                    { 2, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(4299), "Bài test thợ sơn ", 1, new Guid("ce9fa65b-d005-46b6-953e-e6462a59cfb3") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(4215), null, 1, 6, null },
                    { 2, 1, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(4232), null, 1, 6, null },
                    { 3, 1, new DateTime(2023, 3, 24, 12, 52, 40, 815, DateTimeKind.Local).AddTicks(4249), null, 1, 6, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_MaterialStoreID",
                table: "AspNetUsers",
